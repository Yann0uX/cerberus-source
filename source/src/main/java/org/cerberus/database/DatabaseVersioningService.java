...
//-- ------------------------ 609-610
        ...
        //-- ------------------------ 1133-1144
        SQLS = new StringBuilder();
        SQLS.append("UPDATE `parameter` SET `description`='Y if you want to activate proxy.' WHERE `system`='' and`param`='cerberus_callservicerest_proxyactive';");
        SQLInstruction.add(SQLS.toString());
        SQLS = new StringBuilder();
        SQLS.append("UPDATE `parameter` SET `description`='Y if you want to activate proxy authentification.' WHERE `system`='' and`param`='cerberus_callservicerest_proxyauthentificationactive';");
        SQLInstruction.add(SQLS.toString());
        SQLS = new StringBuilder();
        SQLS.append("UPDATE `parameter` SET `description`='Hostname of the proxy.' WHERE `system`='' and`param`='cerberus_callservicerest_proxyhost';");
        SQLInstruction.add(SQLS.toString());
        SQLS = new StringBuilder();
        SQLS.append("UPDATE `parameter` SET `description`='Password to be used in case of proxy with Authentication.' WHERE `system`='' and`param`='cerberus_callservicerest_proxypassword';");
        SQLInstruction.add(SQLS.toString());
        SQLS = new StringBuilder();
        SQLS.append("UPDATE `parameter` SET `description`='Port Number of the proxy.' WHERE `system`='' and`param`='cerberus_callservicerest_proxyport';");
        SQLInstruction.add(SQLS.toString());
        SQLS = new StringBuilder();
        SQLS.append("UPDATE `parameter` SET `description`='Username to be used in case of proxy with Authentication.' WHERE `system`='' and`param`='cerberus_callservicerest_proxyuser';");
        SQLInstruction.add(SQLS.toString());
        SQLS = new StringBuilder();
        SQLS.append("UPDATE `parameter` SET `param`='cerberus_proxy_active' WHERE `param`='cerberus_callservicerest_proxyactive';");
        SQLInstruction.add(SQLS.toString());
        SQLS = new StringBuilder();
        SQLS.append("UPDATE `parameter` SET `param`='cerberus_proxyauthentification_active' WHERE `param`='cerberus_callservicerest_proxyauthentificationactive';");
        SQLInstruction.add(SQLS.toString());
        SQLS = new StringBuilder();
        SQLS.append("UPDATE `parameter` SET `param`='cerberus_proxy_host' WHERE `param`='cerberus_callservicerest_proxyhost';");
        SQLInstruction.add(SQLS.toString());
        SQLS = new StringBuilder();
        SQLS.append("UPDATE `parameter` SET `param`='cerberus_proxyauthentification_password' WHERE `param`='cerberus_callservicerest_proxypassword';");
        SQLInstruction.add(SQLS.toString());
        SQLS = new StringBuilder();
        SQLS.append("UPDATE `parameter` SET `param`='cerberus_proxy_port' WHERE `param`='cerberus_callservicerest_proxyport';");
        SQLInstruction.add(SQLS.toString());
        SQLS = new StringBuilder();
        ...
        //-- ------------------------ 1176-1177
        SQLS = new StringBuilder();
        SQLS.append("ALTER TABLE `testcaseexecutionqueue` DROP FOREIGN KEY `FK_testcaseexecutionqueue_01`;");
        SQLInstruction.add(SQLS.toString());
        SQLS = new StringBuilder();
        SQLS.append("ALTER TABLE `testcaseexecutionqueue` ADD INDEX `IX_testcaseexecution_03` (`DateCreated` ASC);");
        SQLInstruction.add(SQLS.toString());
        ...
        SQLS = new StringBuilder();
        SQLS.append("INSERT INTO `invariant` VALUES ");
        SQLS.append("('MANUALURL', '0', 100, 'Do not activate Application URL Manual definition', '', '', '', '', '', '', '', '', '', '')");
        SQLS.append(",('MANUALURL', '1', 200, 'Activate Application URL Manual definition', '', '', '', '', '', '', '', '', '', '')");
        SQLS.append(",('INVARIANTPUBLIC', 'MANUALURL', '650', '', '', '', '', '', '', '', '', '', '', '');");
        SQLInstruction.add(SQLS.toString());
        ...
        SQLS = new StringBuilder();
        SQLS.append("INSERT INTO `parameter` ");
        SQLS.append("VALUES ('','cerberus_queueexecution_timeout','600000','Parameter that define the time cerberus will wait in ms when triggering an execution from the queue.');");
        SQLInstruction.add(SQLS.toString());
        ...
        //-- ------------------------ 1208
        SQLS = new StringBuilder();
        SQLS.append("ALTER TABLE `documentation` ");
        SQLS.append("ADD COLUMN `DocAnchor` VARCHAR(300) NULL DEFAULT NULL AFTER `DocDesc`;");
        SQLInstruction.add(SQLS.toString());
        ...
        SQLInstruction.add(SQLS.toString());
        SQLS = new StringBuilder();
        SQLS.append("INSERT INTO `documentation` VALUES ('application','Application','','en','Application','','_application_attributes')");
        SQLS.append(",('application','Application','','fr','Application','','_application_attributes')");
        ...
        SQLS.append(",('application','mavengroupid','','fr','Identifiant du groupe Maven','','_application_attributes')");
        SQLS.append(",('application','sort','','en','Sort','This correspond to an integer value that is used as a sorting criteria for various combo box within Cerberus GUI.','_application_attributes')");
        SQLS.append(",('application','sort','','fr','identifiant de Tri','Correspond à une valeur entière et utilisée pour trier les differentes valeurs dans l\\'interface graphique.','_application_attributes')");
        SQLS.append(",('application','subsystem','','en','Subsystem','A <code class=\\'doc-crbvvoca\\'>Subsystem</code> define a group of <code class=\\'doc-crbvvoca\\'>application</code> inside a <code class=\\'doc-crbvvoca\\'>system</code>.','_application_attributes')");
        SQLS.append(",('application','subsystem','','fr','Sous Système','Le <code class=\\'doc-crbvvoca\\'>Sous système</code> regroupe un ensemble d\\'<code class=\\'doc-crbvvoca\\'>application</code> au sein d\\'un même <code class=\\'doc-crbvvoca\\'>système</code>.','_application_attributes')");
        SQLS.append(",('application','svnurl','','en','SVN URL','This correspond to the URL of the svn repository of the <code class=\\'doc-crbvvoca\\'>application</code>.','_application_attributes')");
        SQLS.append(",('application','svnurl','','fr','URL du SVN','Correspond à l\\'URL du SVN de l\\'<code class=\\'doc-crbvvoca\\'>application</code>.','_application_attributes')");
        ...
        SQLS.append(",('appservice','description','','fr','Description','','_librairie_de_services')");
        SQLS.append(",('appservice','group','','en','Group','','_service_library')");
        SQLS.append(",('appservice','group','','fr','Groupe','','_librairie_de_services')");
        SQLS.append(",('appservice','method','','en','Method','','_service_library')");
        SQLS.append(",('appservice','method','','fr','Méthode','','_librairie_de_services')");
        SQLS.append(",('appservice','operation','','en','Operation','','_service_library')");
        SQLS.append(",('appservice','operation','','fr','Operation','','_librairie_de_services')");
        SQLS.append(",('appservice','service','','en','Service','','_service_library')");
        SQLS.append(",('appservice','service','','fr','Service','','_librairie_de_services')");
        SQLS.append(",('appservice','servicePath','','en','Service Path','','_service_library')");
        SQLS.append(",('appservice','servicePath','','fr','Chemin du service','','_librairie_de_services')");
        SQLS.append(",('appservice','srvRequest','','en','Request','','_service_library')");
        SQLS.append(",('appservice','srvRequest','','fr','Requête','','_librairie_de_services')");
        SQLS.append(",('appservice','type','','en','Type','','_service_library')");
        SQLS.append(",('appservice','type','','fr','Type','','_librairie_de_services')");
        SQLS.append(",('batchinvariant','Batch','','en','Batch','','_batch_invariant_attributes')");
        SQLS.append(",('batchinvariant','Batch','','fr','Batch','','_batch_invariant_attributes')");
        SQLS.append(",('batchinvariant','Description','','en','Description','Description of the batch.','_batch_invariant_attributes')");
        SQLS.append(",('batchinvariant','Description','','fr','Description','Description du batch','_batch_invariant_attributes')");
        SQLS.append(",('batchinvariant','system','','en','System','System of the batch','_batch_invariant_attributes')");
        SQLS.append(",('batchinvariant','system','','fr','System','System du batch','_batch_invariant_attributes')");
        SQLS.append(",('buildrevisionbatch','batch','','en','Batch','',NULL)");
        SQLS.append(",('buildrevisionbatch','batch','','fr','Batch','',NULL)");
        SQLS.append(",('buildrevisionbatch','build','','en','Build','Build during the excution of the Batch Event.',NULL)");
        SQLS.append(",('buildrevisionbatch','build','','fr','Build','Build lors de l\\'éxecution de l\\'événement Batch.',NULL)");
        SQLS.append(",('buildrevisionbatch','dateBatch','','en','Date','',NULL)");
        SQLS.append(",('buildrevisionbatch','dateBatch','','fr','Date','',NULL)");
        SQLS.append(",('buildrevisionbatch','revision','','en','Revision','Revision during the excution of the Batch Event.',NULL)");
        SQLS.append(",('buildrevisionbatch','revision','','fr','Revision','Revision lors de l\\'éxecution de l\\'événement Batch.',NULL)");
        SQLS.append(",('buildrevisioninvariant','level','','en','Level','','_build_revision_invariant_attributes')");
        SQLS.append(",('buildrevisioninvariant','level','','fr','Niveau','','_build_revision_invariant_attributes')");
        SQLS.append(",('buildrevisioninvariant','seq','','en','Sequence','','_build_revision_invariant_attributes')");
        SQLS.append(",('buildrevisioninvariant','seq','','fr','Séquence','','_build_revision_invariant_attributes')");
        SQLS.append(",('buildrevisioninvariant','system','','en','System','','_build_revision_invariant_attributes')");
        SQLS.append(",('buildrevisioninvariant','system','','fr','Système','','_build_revision_invariant_attributes')");
        SQLS.append(",('buildrevisioninvariant','versionName','','en','Version Name','','_build_revision_invariant_attributes')");
        SQLS.append(",('buildrevisioninvariant','versionName','','fr','Nom de la Version','','_build_revision_invariant_attributes')");
        SQLS.append(",('buildrevisioninvariant','versionname01','','en','Build','','_build_revision_invariant_attributes')");
        SQLS.append(",('buildrevisioninvariant','versionname01','','fr','Build','','_build_revision_invariant_attributes')");
        SQLS.append(",('buildrevisioninvariant','versionname02','','en','Revision','','_build_revision_invariant_attributes')");
        SQLS.append(",('buildrevisioninvariant','versionname02','','fr','Revision','','_build_revision_invariant_attributes')");
        SQLS.append(",('buildrevisionparameters','application','','en','Application','','_build_content')");
        SQLS.append(",('buildrevisionparameters','application','','fr','Application','','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','BugIDFixed','','en','Associated Bug ID','This is the bug ID which has been solved with the <code class=\\'doc-crbvvoca\\'>release</code>.','_build_content')");
        SQLS.append(",('buildrevisionparameters','BugIDFixed','','fr','ID du Bug associé','ID du bug dont la release est associée.','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','Build','','en','Build','','_build_content')");
        SQLS.append(",('buildrevisionparameters','Build','','fr','Build','','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','datecre','','en','Creation Date','','_build_content')");
        SQLS.append(",('buildrevisionparameters','datecre','','fr','Date de Création','','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','id','','en','ID','','_build_content')");
        SQLS.append(",('buildrevisionparameters','id','','fr','ID','','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','jenkinsBuildId','','en','Jenkins Build ID','','_build_content')");
        SQLS.append(",('buildrevisionparameters','jenkinsBuildId','','fr','ID du build Jenkins','','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','Link','','en','Link','This is the link to the detailed content of the <code class=\\'doc-crbvvoca\\'>release</code>.','_build_content')");
        SQLS.append(",('buildrevisionparameters','Link','','fr','Lien','Lien vers le detail de la <code class=\\'doc-crbvvoca\\'>release</code>.','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','mavenArtifactId','','en','Maven Artifact ID','','_build_content')");
        SQLS.append(",('buildrevisionparameters','mavenArtifactId','','fr','Maven Artifact ID','','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','mavenGroupId','','en','Maven Group ID','','_build_content')");
        SQLS.append(",('buildrevisionparameters','mavenGroupId','','fr','ID du groupe Maven','','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','mavenVersion','','en','Maven Version','','_build_content')");
        SQLS.append(",('buildrevisionparameters','mavenVersion','','fr','Maven Version','','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','project','','en','Project','','_build_content')");
        SQLS.append(",('buildrevisionparameters','project','','fr','Projet','','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','Release','','en','Release','A <code class=\\'doc-crbvvoca\\'>release</code> is a single change done on the <code class=\\'doc-crbvvoca\\'>application</code>.','_build_content')");
        SQLS.append(",('buildrevisionparameters','Release','','fr','Release','A <code class=\\'doc-crbvvoca\\'>release</code> is a single change done on the <code class=\\'doc-crbvvoca\\'>application</code>.','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','ReleaseOwner','','en','Owner','This is the name of the person who is responsible for the <code class=\\'doc-crbvvoca\\'>release</code>.','_build_content')");
        SQLS.append(",('buildrevisionparameters','ReleaseOwner','','fr','Responsable','Nom de la personne responsable de la <code class=\\'doc-crbvvoca\\'>release</code>.','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','repositoryUrl','','en','Repository URL','This information corresponds to the URL where the current build of the <code class=\\'doc-crbvvoca\\'>application</code> can be downloaded.<br>It allow to retrieve it in a repository such as Nexus.','_build_content')");
        SQLS.append(",('buildrevisionparameters','repositoryUrl','','fr','URL du Dépot','Cette information correspond à l\\'URL d\\'où le build de l\\'<code class=\\'doc-crbvvoca\\'>application</code> peut-être téléchargé.<br>Cela permet de retrouver un build spécifique dans un dépot de livrable de type Nexus.','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','Revision','','en','Revision','','_build_content')");
        SQLS.append(",('buildrevisionparameters','Revision','','fr','Revision','','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','subject','','en','Description','','_build_content')");
        SQLS.append(",('buildrevisionparameters','subject','','fr','Description','','_contenu_des_builds')");
        SQLS.append(",('buildrevisionparameters','TicketIDFixed','','en','Associated Ticket ID','This is the Ticket ID which has been delivered with the <code class=\\'doc-crbvvoca\\'>release</code>.','_build_content')");
        SQLS.append(",('buildrevisionparameters','TicketIDFixed','','fr','ID du Ticket associé','ID du ticket dont la release est associée.','_contenu_des_builds')");
        SQLS.append(",('countryenvdeploytype','JenkinsAgent','','en','Jenkins Agent','','_deploy_type')");
        SQLS.append(",('countryenvdeploytype','JenkinsAgent','','fr','Agent Jenkins','','_type_de_déploiement')");
        ...
        SQLS.append(",('countryenvironmentdatabase','Database','','en','Database','','_environment')");
        ...
        SQLS.append(",('countryenvironmentparameters','URLLOGIN','','en','Login URL','Path to login page. This path is used only when calling the <code class=\\'doc-action\\'>openUrlLogin</code> Action.','_environment')");
        SQLS.append(",('countryenvironmentparameters','URLLOGIN','','fr','URL de Login','Chemin vers la page de login. Ce chemin peut être utilisé à partir de l\\'action <code class=\\'doc-action\\'>openUrlLogin</code>.','_environnement')");
        SQLS.append(",('countryenvironmentparameters','Var1','','en','Variable 1','Variable can be used inside testcases with %SYS_APP_VAR1% variable.','_environment')");
        SQLS.append(",('countryenvironmentparameters','Var1','','fr','Variable 1','Variable qui peut être utilisée dans les test avec : %SYS_APP_VAR1%','_environnement')");
        SQLS.append(",('countryenvironmentparameters','Var2','','en','Variable 2','Variable can be used inside testcases with %SYS_APP_VAR2% variable.','_environment')");
        SQLS.append(",('countryenvironmentparameters','Var2','','fr','Variable 2','Variable qui peut être utilisée dans les test avec : %SYS_APP_VAR2%','_environnement')");
        SQLS.append(",('countryenvironmentparameters','Var3','','en','Variable 3','Variable can be used inside testcases with %SYS_APP_VAR3% variable.','_environment')");
        SQLS.append(",('countryenvironmentparameters','Var3','','fr','Variable 3','Variable qui peut être utilisée dans les test avec : %SYS_APP_VAR3%','_environnement')");
        SQLS.append(",('countryenvironmentparameters','Var4','','en','Variable 4','Variable can be used inside testcases with %SYS_APP_VAR4% variable.','_environment')");
        SQLS.append(",('countryenvironmentparameters','Var4','','fr','Variable 4','Variable qui peut être utilisée dans les test avec : %SYS_APP_VAR4%','_environnement')");
        SQLS.append(",('countryenvlink','CountryLink','','en','Country linked','','_environment')");
        SQLS.append(",('countryenvlink','CountryLink','','fr','Pays lié','','_environnement')");
        SQLS.append(",('countryenvlink','EnvironmentLink','','en','Environment linked','','_environment')");
        SQLS.append(",('countryenvlink','EnvironmentLink','','fr','Environnement lié','','_environnement')");
        SQLS.append(",('countryenvlink','systemLink','','en','System','','_environment')");
        SQLS.append(",('countryenvlink','systemLink','','fr','System','','_environnement')");
        SQLS.append(",('countryenvparam','active','','en','Active','Define if the <code class=\\'doc-crbvvoca\\'>environment</code> is active or not. A <code class=\\'doc-crbvvoca\\'>test case</code> cannot be executed against an <code class=\\'doc-crbvvoca\\'>environment</code> that is not  active.','_environment')");
        SQLS.append(",('countryenvparam','active','','fr','Actif','','_environnement')");
        SQLS.append(",('countryenvparam','chain','','en','Chain','','_environment')");
        SQLS.append(",('countryenvparam','chain','','fr','Chaine','','_environnement')");
        SQLS.append(",('countryenvparam','Description','','en','Description','','_environment')");
        SQLS.append(",('countryenvparam','Description','','fr','Description','','_environnement')");
        SQLS.append(",('countryenvparam','DistribList','','en','Recipent list of Notification Email','This is the list of email adresses that will receive the notification on any environment event.<br><br>In case that value is not feeded, the following parameters are used (depending on the related event) :<br><code class=\\'doc-parameter\\'>integration_notification_disableenvironment_to</code><br><code class=\\'doc-parameter\\'>integration_notification_newbuildrevision_to</code><br><code class=\\'doc-parameter\\'>integration_notification_newchain_to</code>','_environment')");
        SQLS.append(",('countryenvparam','DistribList','','fr','Emails des destinataires','','_environnement')");
        SQLS.append(",('countryenvparam','EMailBodyChain','','en','EMail Body on New Chain Executed Event','This is the Body of the mail that will be generated when a new Treatment has been executed on the <code class=\\'doc-crbvvoca\\'>environment</code>.<br><br><table cellspacing=0 cellpadding=3><th class=\\'ex\\' colspan=\\'2\\'>The following variable can be used</th><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%SYSTEM%</code></td><td class=\\'ex\\'>System value</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%COUNTRY%</code></td><td class=\\'ex\\'>Country code</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%ENV%</code></td><td class=\\'ex\\'>Environment code</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%BUILD%</code></td><td class=\\'ex\\'>Current Build version name</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%REVISION%</code></td><td class=\\'ex\\'>Current Revision version name</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%CHAIN%</code></td><td class=\\'ex\\'>Chain value that has been executed</td></tr></table><br>In case that value is not feeded, the following parameter is used :<br><code class=\\'doc-parameter\\'>integration_notification_newchain_body</code>','_environment')");
        SQLS.append(",('countryenvparam','EMailBodyChain','','fr','Corps du message en cas de nouvelle Chaine','','_environnement')");
        ...
        SQLS.append(",('countryenvparam','EMailBodyDisableEnvironment','','fr','Corps du message en cas de désactivation','','_environnement')");
        ...
        SQLS.append(",('countryenvparam','EMailBodyRevision','','fr','Corps du message en cas de nouvelle Revision','','_environnement')");
        ...
        SQLS.append(",('countryenvparam','maintenanceact','','fr','Activation de la plage de maintenance','','_environnement')");
        ...
        SQLS.append(",('countryenvparam','maintenanceend','','fr','Heure de fin de la plage de maintenance','','_environnement')");
        ...
        SQLS.append(",('countryenvparam','maintenancestr','','fr','Heure de début de la plage de maintenance','','_environnement')");
        SQLS.append(",('countryenvparam','system','','en','System','','_environment')");
        SQLS.append(",('countryenvparam','system','','fr','Système','','_environnement')");
        ...
        SQLS.append(",('countryenvparam','Type','','fr','Type','','_environnement')");
        SQLS.append(",('countryenvparam_log','Creator','','en','User','',NULL)");
        SQLS.append(",('countryenvparam_log','Creator','','fr','Utilisateur','',NULL)");
        SQLS.append(",('countryenvparam_log','datecre','','en','Date & Time','',NULL)");
        SQLS.append(",('countryenvparam_log','datecre','','fr','Date & Heure','',NULL)");
        SQLS.append(",('countryenvparam_log','Description','','en','Description','',NULL)");
        SQLS.append(",('countryenvparam_log','Description','','fr','Description','',NULL)");
        SQLS.append(",('dataTable','colVis','','en','Show/Hide columns','',NULL)");
        SQLS.append(",('dataTable','colVis','','fr','Afficher/Cacher les colonnes','',NULL)");
        SQLS.append(",('dataTable','sEmptyTable','','en','No data available in table','',NULL)");
        SQLS.append(",('dataTable','sEmptyTable','','fr','Aucune donn&eacute;e disponible dans le tableau','',NULL)");
        SQLS.append(",('dataTable','sFirst','','en','First','',NULL)");
        SQLS.append(",('dataTable','sFirst','','fr','Premier','',NULL)");
        SQLS.append(",('dataTable','sInfo','','en','Showing _START_ to _END_ of _TOTAL_ entries','',NULL)");
        SQLS.append(",('dataTable','sInfo','','fr','Affichage de l\\'&eacute;l&eacute;ment _START_ &agrave; _END_ sur _TOTAL_ &eacute;l&eacute;ments','',NULL)");
        SQLS.append(",('dataTable','sInfoEmpty','','en','Showing 0 to 0 of 0 entries','',NULL)");
        SQLS.append(",('dataTable','sInfoEmpty','','fr','Affichage de l\\'&eacute;l&eacute;ment 0 &agrave; 0 sur 0 &eacute;l&eacute;ments','',NULL)");
        SQLS.append(",('dataTable','sInfoFiltered','','en','(filtered from _MAX_ total entries)','',NULL)");
        SQLS.append(",('dataTable','sInfoFiltered','','fr','(filtr&eacute; de _MAX_ &eacute;l&eacute;ments au total)','',NULL)");
        SQLS.append(",('dataTable','sInfoPostFix','','en','','',NULL)");
        SQLS.append(",('dataTable','sInfoPostFix','','fr','','',NULL)");
        SQLS.append(",('dataTable','sInfoThousands','','en',',','',NULL)");
        SQLS.append(",('dataTable','sInfoThousands','','fr',',','',NULL)");
        SQLS.append(",('dataTable','sLast','','en','Last','',NULL)");
        SQLS.append(",('dataTable','sLast','','fr','Dernier','',NULL)");
        SQLS.append(",('dataTable','sLengthMenu','','en','_MENU_','',NULL)");
        SQLS.append(",('dataTable','sLengthMenu','','fr','_MENU_','',NULL)");
        SQLS.append(",('dataTable','sLoadingRecords','','en','Loading...','',NULL)");
        SQLS.append(",('dataTable','sLoadingRecords','','fr','Chargement en cours...','',NULL)");
        SQLS.append(",('dataTable','sNext','','en','Next','',NULL)");
        SQLS.append(",('dataTable','sNext','','fr','Suivant','',NULL)");
        SQLS.append(",('dataTable','sPrevious','','en','Previous','',NULL)");
        SQLS.append(",('dataTable','sPrevious','','fr','Pr&eacute;c&eacute;dent','',NULL)");
        SQLS.append(",('dataTable','sProcessing','','en','Processing...','',NULL)");
        SQLS.append(",('dataTable','sProcessing','','fr','Traitement en cours...','',NULL)");
        SQLS.append(",('dataTable','sSearch','','en','_INPUT_','',NULL)");
        SQLS.append(",('dataTable','sSearch','','fr','_INPUT_','',NULL)");
        SQLS.append(",('dataTable','sSearchPlaceholder','','en','Search...','',NULL)");
        SQLS.append(",('dataTable','sSearchPlaceholder','','fr','Rechercher...','',NULL)");
        SQLS.append(",('dataTable','sSortAscending','','en',': activate to sort column ascending','',NULL)");
        SQLS.append(",('dataTable','sSortAscending','','fr',': activer pour trier la colonne par ordre croissant','',NULL)");
        SQLS.append(",('dataTable','sSortDescending','','en',': activate to sort column descending','',NULL)");
        SQLS.append(",('dataTable','sSortDescending','','fr',': activer pour trier la colonne par ordre d&eacute;croissant','',NULL)");
        SQLS.append(",('dataTable','sZeroRecords','','en','No matching records found','',NULL)");
        SQLS.append(",('dataTable','sZeroRecords','','fr','Aucun &eacute;l&eacute;ment &agrave; afficher','',NULL)");
        SQLS.append(",('deploytype','deploytype','','en','Deployment Type','',NULL)");
        SQLS.append(",('deploytype','deploytype','','fr','Type de deploiement','',NULL)");
        SQLS.append(",('deploytype','description','','en','Description','',NULL)");
        SQLS.append(",('deploytype','description','','fr','Description','',NULL)");
        SQLS.append(",('homepage','btn_addTag','','en','Add Tag','',NULL)");
        SQLS.append(",('homepage','btn_addTag','','fr','Ajouter le tag','',NULL)");
        SQLS.append(",('homepage','btn_settings','','en','Customize','',NULL)");
        SQLS.append(",('homepage','btn_settings','','fr','Personnaliser','',NULL)");
        SQLS.append(",('homepage','lastTagExecution','','en','Last Tags Executions','Display the statistics of the last tag executed or the tags set in the settings',NULL)");
        SQLS.append(",('homepage','lastTagExecution','','fr','Dernières exécutions de tags','Affiche les statistiques d\\'exécutions des derniers tags exécutés ou des tags définis dans les options',NULL)");
        SQLS.append(",('homepage','modal_title','','en','Tag Filter','This modal permits you to add tags to the last tags executions report',NULL)");
        SQLS.append(",('homepage','modal_title','','fr','Filtre des tags','Ce modal vous permet d\\'ajouter des tags au rapport des dernières exécutions de tags',NULL)");
        SQLS.append(",('homepage','testCaseStatusByApp','','en','Test Case Status by Application','Workflow status of the test case by Application',NULL)");
        SQLS.append(",('homepage','testCaseStatusByApp','','fr','Statut des Cas de Test par Application','Status de l\\'avancement des cas de tests par Application',NULL)");
        SQLS.append(",('homepage','title','','en','Welcome to Cerberus application','',NULL)");
        SQLS.append(",('homepage','title','','fr','Bienvenue dans l\\'application Cerberus','',NULL)");
        SQLS.append(",('host','active','','en','Active','',NULL)");
        SQLS.append(",('host','host','','en','Host','',NULL)");
        SQLS.append(",('host','port','','en','port','',NULL)");
        SQLS.append(",('host','secure','','en','secure','',NULL)");
        SQLS.append(",('host','secure','','fr','garantie',NULL,NULL)");
        SQLS.append(",('host','Server','','en','Server','This is used to define different host on different server for resilence purpose. You can use that for PRIMARY and BACKUP access.',NULL)");
        SQLS.append(",('host','Server','','fr','Serveur',NULL,NULL)");
        SQLS.append(",('host','Session','','en','Session','',NULL)");
        SQLS.append(",('host','Session','','fr','Session',NULL,NULL)");
        ...
        SQLS.append(",('invariant','ENVGP','','en','Environment Group','',NULL)");
        SQLS.append(",('invariant','ENVGP','','fr','Groupe d\\'Environnement','',NULL)");
        SQLS.append(",('invariant','ENVIRONMENT','','en','Environment','',NULL)");
        SQLS.append(",('invariant','ENVIRONMENT','','fr','Environnement','',NULL)");
        SQLS.append(",('invariant','FILTERNBDAYS','','en','Nb Days','Number of days to Filter the history table in the integration status.',NULL)");
        SQLS.append(",('invariant','FILTERNBDAYS','','fr','Nb Jours','',NULL)");
        ...
        SQLS.append(",('invariant','GROUP','','fr','Groupe','',NULL)");
        SQLS.append(",('invariant','PRIORITY','','en','Priority','It is the priority level of the functionnality which is tested.',NULL)");
        SQLS.append(",('invariant','PRIORITY','','fr','Priorité','',NULL)");
        SQLS.append(",('invariant','SYSTEM','','en','System','',NULL)");
        SQLS.append(",('invariant','SYSTEM','','fr','Système','',NULL)");
        SQLS.append(",('label','color','','en','Color','<p>This field is the color that will be applyied to the label. It could be any value understable by the brower.</p><p>Examples: blue |  #00FF00 | #000 </p>',NULL)");
        SQLS.append(",('label','color','','fr','Couleur','<p>Cette valeur représente la couleur appliquée au label. Cela peut-être toute valeur reconnue comme couleur par le navigateur.</p><p>Exemples: blue |  #00FF00 | #000 </p>',NULL)");
        SQLS.append(",('label','description','','en','Description','<p>Description of the label.</p>',NULL)");
        SQLS.append(",('label','description','','fr','Description','<p>Description du label.</p>',NULL)");
        SQLS.append(",('label','id','','en','ID','',NULL)");
        ...
        SQLS.append(",('logevent','localip','','fr','IP Locale','IP du serveur Cerberus qui a répondu à la requette.',NULL)");
        SQLS.append(",('logevent','log','','en','Log','Log message of the action.',NULL)");
        SQLS.append(",('logevent','log','','fr','Message','Message lié à l\\'action.',NULL)");
        SQLS.append(",('logevent','logeventid','','en','Log Entry ID','Unique identifier of the log entry.',NULL)");
        SQLS.append(",('logevent','logeventid','','fr','Identifiant du log','Identifiant unique de l\\'entrée de log.',NULL)");
        SQLS.append(",('logevent','login','','en','Login','Login of the user who performed the action.',NULL)");
        SQLS.append(",('logevent','login','','fr','Utilisateur','Nom de l\\'utilisateur qui a effectué l\\'action.',NULL)");
        SQLS.append(",('logevent','page','','en','Page','Name of the page where the action was performed.',NULL)");
        SQLS.append(",('logevent','page','','fr','Page','Nom de la page où l\\'action a été effectuée.',NULL)");
        SQLS.append(",('logevent','remoteip','','en','Remote IP','IP from which the user connected to Cerberus to perform the action.',NULL)");
        SQLS.append(",('logevent','remoteip','','fr','IP Distante','IP à partir de laquelle l\\'utilisateur s\\'est connecté à Cerberus.',NULL)");
        SQLS.append(",('logevent','time','','en','Time','Timestamp of the log message.',NULL)");
        SQLS.append(",('logevent','time','','fr','Date','Date à laquelle l\\'action a été effectuée.',NULL)");
        SQLS.append(",('modal_upload','btn_cancel','','en','Cancel','',NULL)");
        SQLS.append(",('modal_upload','btn_cancel','','fr','Annuler','',NULL)");
        SQLS.append(",('modal_upload','btn_choose','','en','Choose File','',NULL)");
        SQLS.append(",('modal_upload','btn_choose','','fr','Choisir','',NULL)");
        SQLS.append(",('modal_upload','btn_upload','','en','Upload','',NULL)");
        SQLS.append(",('modal_upload','btn_upload','','fr','Uploader','',NULL)");
        SQLS.append(",('modal_upload','title','','en','Upload File','',NULL)");
        SQLS.append(",('modal_upload','title','','fr','Uploader Fichier','',NULL)");
        SQLS.append(",('multiselect','all_selected','','en','All selected','',NULL)");
        SQLS.append(",('multiselect','all_selected','','fr','Tous selectionner','',NULL)");
        SQLS.append(",('multiselect','none_selected','','en','None selected','',NULL)");
        SQLS.append(",('multiselect','none_selected','','fr','Selectionner aucun','',NULL)");
        SQLS.append(",('multiselect','nselected','','en','selected','',NULL)");
        SQLS.append(",('multiselect','nselected','','fr','Selectionné','',NULL)");
        SQLS.append(",('multiselect','search','','en','Search','',NULL)");
        SQLS.append(",('multiselect','search','','fr','Chercher','',NULL)");
        SQLS.append(",('multiselect','select_all','','en','Select all','',NULL)");
        SQLS.append(",('multiselect','select_all','','fr','Selectionner tous','',NULL)");
        SQLS.append(",('myversion','key','','en','Key','This is the reference of the component inside Cerberus that we want to keep track of the version.',NULL)");
        SQLS.append(",('myversion','key','','fr','Clé',NULL,NULL)");
        SQLS.append(",('myversion','value','','en','Value','This is the version that correspond to the key.',NULL)");
        SQLS.append(",('page_application','button_create','','en','Create new Application','',NULL)");
        SQLS.append(",('page_application','button_create','','fr','Créer une nouvelle Application','',NULL)");
        SQLS.append(",('page_application','button_delete','','en','Delete Application','',NULL)");
        ...
        SQLS.append(",('page_application','tabDef','','fr','Definition','',NULL)");
        SQLS.append(",('page_application','tabEnv','','en','Environments','',NULL)");
        SQLS.append(",('page_application','tabEnv','','fr','Environnements','',NULL)");
        SQLS.append(",('page_application','table_application','','en','Application List',NULL,NULL)");
        SQLS.append(",('page_application','table_application','','fr','Liste des Applications',NULL,NULL)");
        SQLS.append(",('page_application','title','','en','APPLICATION','This page can be used to manage the applications.','_application')");
        SQLS.append(",('page_application','title','','fr','APPLICATION','Cette page permet de gérer et créer des applications.','_application')");
        SQLS.append(",('page_applicationObject','Application','','en','Application','',NULL)");
        SQLS.append(",('page_applicationObject','Application','','fr','Application','',NULL)");
        SQLS.append(",('page_applicationObject','applicationfield','','en','Application','',NULL)");
        SQLS.append(",('page_applicationObject','applicationfield','','fr','Application','',NULL)");
        SQLS.append(",('page_applicationObject','button_add','','en','Add','',NULL)");
        SQLS.append(",('page_applicationObject','button_add','','fr','Ajouter','',NULL)");
        SQLS.append(",('page_applicationObject','button_close','','en','Close','',NULL)");
        SQLS.append(",('page_applicationObject','button_close','','fr','Fermer','',NULL)");
        SQLS.append(",('page_applicationObject','button_create','','en','Create an Application Object','',NULL)");
        SQLS.append(",('page_applicationObject','button_create','','fr','Créer un objet d\\'application','',NULL)");
        SQLS.append(",('page_applicationObject','button_delete','','en','Delete Object','',NULL)");
        SQLS.append(",('page_applicationObject','button_delete','','fr','Supprimer l\\'objet','',NULL)");
        SQLS.append(",('page_applicationObject','button_edit','','en','Edit Object','',NULL)");
        SQLS.append(",('page_applicationObject','button_edit','','fr','Modifier l\\'objet','',NULL)");
        SQLS.append(",('page_applicationObject','createapplicationobjectfield','','en','Create Application Object','',NULL)");
        SQLS.append(",('page_applicationObject','createapplicationobjectfield','','fr','Créer un object d\\'application','',NULL)");
        SQLS.append(",('page_applicationObject','DateCreated','','en','Creation date','',NULL)");
        SQLS.append(",('page_applicationObject','DateCreated','','fr','Date de création','',NULL)");
        SQLS.append(",('page_applicationObject','DateModif','','en','Last modification date','',NULL)");
        SQLS.append(",('page_applicationObject','DateModif','','fr','Date de dernière modification','',NULL)");
        SQLS.append(",('page_applicationObject','editapplicationobjectfield','','en','Edit Application Object','',NULL)");
        SQLS.append(",('page_applicationObject','editapplicationobjectfield','','fr','Modifier un objet d\\'application','',NULL)");
        SQLS.append(",('page_applicationObject','message_delete','','en','Do you want to delete Application Object <b>\\'%ENTRY%\\'</b> ?','',NULL)");
        SQLS.append(",('page_applicationObject','message_delete','','fr','Confirmez vous la suppression de l\\'objet <b>\\'%ENTRY%\\'</b> ?','',NULL)");
        SQLS.append(",('page_applicationObject','Object','','en','Object','',NULL)");
        SQLS.append(",('page_applicationObject','Object','','fr','Objet','',NULL)");
        SQLS.append(",('page_applicationObject','objectfield','','en','Object','',NULL)");
        SQLS.append(",('page_applicationObject','objectfield','','fr','Objet','',NULL)");
        SQLS.append(",('page_applicationObject','ScreenshotFileName','','en','File Name','',NULL)");
        SQLS.append(",('page_applicationObject','ScreenshotFileName','','fr','Nom du fichier','',NULL)");
        SQLS.append(",('page_applicationObject','screenshotfilenamefield','','en','FileName','',NULL)");
        SQLS.append(",('page_applicationObject','screenshotfilenamefield','','fr','Nom du ficher','',NULL)");
        SQLS.append(",('page_applicationObject','table_applicationobject','','en','Application Object List',NULL,NULL)");
        SQLS.append(",('page_applicationObject','table_applicationobject','','fr','Liste des Objets d\\'Application',NULL,NULL)");
        SQLS.append(",('page_applicationObject','title','','en','Application Object','This page can be used to manage the application objects.','_application_object')");
        SQLS.append(",('page_applicationObject','title','','fr','Objet d\\'application','Cette page permet de gérer et créer des objets d\\'application.','_objet_d_application')");
        SQLS.append(",('page_applicationObject','UsrCreated','','en','Creator','',NULL)");
        SQLS.append(",('page_applicationObject','UsrCreated','','fr','Createur','',NULL)");
        SQLS.append(",('page_applicationObject','UsrModif','','en','Last Modificator','',NULL)");
        SQLS.append(",('page_applicationObject','UsrModif','','fr','Dernier Editeur','',NULL)");
        SQLS.append(",('page_applicationObject','Value','','en','Value','',NULL)");
        SQLS.append(",('page_applicationObject','Value','','fr','Valeur','',NULL)");
        SQLS.append(",('page_applicationObject','valuefield','','en','Value','',NULL)");
        SQLS.append(",('page_applicationObject','valuefield','','fr','Valeur','',NULL)");
        SQLS.append(",('page_appservice','addSoapLibrary_field','','en','Add Service','',NULL)");
        SQLS.append(",('page_appservice','addSoapLibrary_field','','fr','Ajouter un Service','',NULL)");
        SQLS.append(",('page_appservice','allSoapLibrarys','','en','Service Library','',NULL)");
        SQLS.append(",('page_appservice','allSoapLibrarys','','fr','Bibliotheque de Service','',NULL)");
        SQLS.append(",('page_appservice','button_col','','en','Actions','',NULL)");
        SQLS.append(",('page_appservice','button_col','','fr','Actions','',NULL)");
        SQLS.append(",('page_appservice','button_create','','en','Add Service','',NULL)");
        SQLS.append(",('page_appservice','button_create','','fr','Ajouter un Service','',NULL)");
        SQLS.append(",('page_appservice','button_duplicate','','en','Duplicate Service',NULL,NULL)");
        SQLS.append(",('page_appservice','button_duplicate','','fr','Dupliquer Service',NULL,NULL)");
        SQLS.append(",('page_appservice','button_edit','','en','Edit Service','',NULL)");
        SQLS.append(",('page_appservice','button_edit','','fr','Editer le Service','',NULL)");
        SQLS.append(",('page_appservice','button_remove','','en','Delete Service','',NULL)");
        SQLS.append(",('page_appservice','button_remove','','fr','Supprimer le Service','',NULL)");
        SQLS.append(",('page_appservice','close_btn','','en','Close','',NULL)");
        SQLS.append(",('page_appservice','close_btn','','fr','Fermer','',NULL)");
        SQLS.append(",('page_appservice','editSoapLibrary_field','','en','Edit Service','',NULL)");
        SQLS.append(",('page_appservice','editSoapLibrary_field','','fr','Editer le Service','',NULL)");
        SQLS.append(",('page_appservice','message_remove','','en','Are you sure to delete the service \\'%SERVICE%\\' ?','',NULL)");
        SQLS.append(",('page_appservice','message_remove','','fr','Êtes-vous sûrs de supprimer le service \\'%SERVICE%\\' ?','',NULL)");
        SQLS.append(",('page_appservice','save_btn','','en','Save Service','',NULL)");
        SQLS.append(",('page_appservice','save_btn','','fr','Sauvegarder le Service','',NULL)");
        SQLS.append(",('page_appservice','table_service','','en','Service',NULL,NULL)");
        SQLS.append(",('page_appservice','table_service','','fr','Service',NULL,NULL)");
        SQLS.append(",('page_appservice','title_remove','','en','Delete Service','',NULL)");
        SQLS.append(",('page_appservice','title_remove','','fr','Supprimer le Service','',NULL)");
        SQLS.append(",('page_batchinvariant','button_create','','en','Create new Batch','',NULL)");
        SQLS.append(",('page_batchinvariant','button_create','','fr','Créer un nouveau Batch','',NULL)");
        SQLS.append(",('page_batchinvariant','button_delete','','en','Delete Batch','',NULL)");
        SQLS.append(",('page_batchinvariant','button_delete','','fr','Supprimer le Batch','',NULL)");
        SQLS.append(",('page_batchinvariant','button_edit','','en','Edit Batch','',NULL)");
        SQLS.append(",('page_batchinvariant','button_edit','','fr','Modifier le Batch','',NULL)");
        SQLS.append(",('page_batchinvariant','message_delete','','en','Do you want to delete Batch <b>\\'%ENTRY%\\'</b> ?<br>WARNING1 : All corresponding Batch execution history will be deleted !!!','',NULL)");
        SQLS.append(",('page_batchinvariant','message_delete','','fr','Confirmez vous la suppression du Batch <b>\\'%ENTRY%\\'</b> ?<br> ATTENTION1 : Tous les Historiques d\\'executions seront suprimés !!!','',NULL)");
        SQLS.append(",('page_batchinvariant','table_batch','','en','Batch',NULL,NULL)");
        SQLS.append(",('page_batchinvariant','table_batch','','fr','Liste des Batchs',NULL,NULL)");
        SQLS.append(",('page_batchinvariant','title','','en','BATCH','This page can be used in order to manage the batch per system.','_batch')");
        SQLS.append(",('page_batchinvariant','title','','fr','BATCH','Cette page permet de gérer et créer des batch pour chaque systeme.','_chaine')");
        SQLS.append(",('page_buildcontent','buildFrom','','en','From Build/Rev','',NULL)");
        SQLS.append(",('page_buildcontent','buildFrom','','fr','De Build/Rev','',NULL)");
        SQLS.append(",('page_buildcontent','buildTo','','en','To Build/Rev','',NULL)");
        SQLS.append(",('page_buildcontent','buildTo','','fr','Vers Build/Rev','',NULL)");
        SQLS.append(",('page_buildcontent','buttonInstallInstruction','','en','See Installation Instructions','',NULL)");
        SQLS.append(",('page_buildcontent','buttonInstallInstruction','','fr','Voir Instructions d\\'installation','',NULL)");
        SQLS.append(",('page_buildcontent','buttonLoadAll','','en','Load All Build','',NULL)");
        SQLS.append(",('page_buildcontent','buttonLoadAll','','fr','Charger tous','',NULL)");
        SQLS.append(",('page_buildcontent','buttonLoadLatest','','en','Load latest Build','',NULL)");
        SQLS.append(",('page_buildcontent','buttonLoadLatest','','fr','Charger le dernier Build','',NULL)");
        SQLS.append(",('page_buildcontent','buttonLoadPending','','en','Load pending Build','',NULL)");
        SQLS.append(",('page_buildcontent','buttonLoadPending','','fr','Charger le Build en cours','',NULL)");
        SQLS.append(",('page_buildcontent','button_create','','en','Create new Build Content','',NULL)");
        SQLS.append(",('page_buildcontent','button_create','','fr','Créer un nouveau contenu au Build','',NULL)");
        SQLS.append(",('page_buildcontent','button_delete','','en','Delete Build Content','',NULL)");
        SQLS.append(",('page_buildcontent','button_delete','','fr','Supprimer l\\'entrée du contenu du Build','',NULL)");
        SQLS.append(",('page_buildcontent','button_edit','','en','Edit Build Content','',NULL)");
        SQLS.append(",('page_buildcontent','button_edit','','fr','Editer le contenu du Build','',NULL)");
        SQLS.append(",('page_buildcontent','delete','','en','Dlt','Select this checkbox and then save changes in order to delete the row.',NULL)");
        SQLS.append(",('page_buildcontent','delete','','fr','Dlt','Select this checkbox and then save changes in order to delete the row.',NULL)");
        SQLS.append(",('page_buildcontent','filters','','en','Filters','',NULL)");
        SQLS.append(",('page_buildcontent','filters','','fr','Filtres','',NULL)");
        SQLS.append(",('page_buildcontent','InstallInstructions','','en','Installation instructions','',NULL)");
        SQLS.append(",('page_buildcontent','InstallInstructions','','fr','Instructions d\\'installation','',NULL)");
        SQLS.append(",('page_buildcontent','list','','en','Build Content List','',NULL)");
        SQLS.append(",('page_buildcontent','list','','fr','Liste du contenu du Build','',NULL)");
        SQLS.append(",('page_buildcontent','massAction','','en','Massively update the selected release','',NULL)");
        SQLS.append(",('page_buildcontent','massAction','','fr','Mise à jour massive des releases selectionnées','',NULL)");
        SQLS.append(",('page_buildcontent','message_delete','','en','Do you want to delete release entry <b>\\'%ENTRY%\\'</b> ?<br> NB : It correspond to the release <b>\\'%RELEASE%\\'</b> of application <b>\\'%APPLI%\\'</b> of Build <b>\\'%BUILD%\\'</b> Revision <b>\\'%REVISION%\\'</b>.','',NULL)");
        SQLS.append(",('page_buildcontent','message_delete','','fr','Confirmez vous la suppression de l\\'entrée <b>\\'%ENTRY%\\'</b> ?<br> NB : correspond à la release <b>\\'%RELEASE%\\'</b> de l\\'application <b>\\'%APPLI%\\'</b> du Build <b>\\'%BUILD%\\'</b> Revision <b>\\'%REVISION%\\'</b>.','',NULL)");
        SQLS.append(",('page_buildcontent','message_instruction','','en','Please specify a build and a revision to get the installation instructions!',NULL,NULL)");
        SQLS.append(",('page_buildcontent','message_instruction','','fr','Merci de specifier un build et une revision avant d\\'obtenir les instructions d\\'installation! ',NULL,NULL)");
        SQLS.append(",('page_buildcontent','message_massAction','','en','Massively update the selected release',NULL,NULL)");
        SQLS.append(",('page_buildcontent','message_massAction','','fr','Mettre à jours en masse les releases selectionnées',NULL,NULL)");
        SQLS.append(",('page_buildcontent','standardfilters','','en','Standard Filters','',NULL)");
        SQLS.append(",('page_buildcontent','standardfilters','','fr','Standard Filters','',NULL)");
        SQLS.append(",('page_buildcontent','title','','en','BUILD CONTENT','This page can be used to manage the Build Content.','_build_content')");
        SQLS.append(",('page_buildcontent','title','','fr','CONTENU DES BUILDS','Cette page permet de gérer le contenu d\\'un build.','_contenu_des_builds')");
        SQLS.append(",('page_buildrevdefinition','button_create','','en','Create new Build Revision Definition','',NULL)");
        SQLS.append(",('page_buildrevdefinition','button_create','','fr','Créer une nouvelle definition de build ou revision','',NULL)");
        SQLS.append(",('page_buildrevdefinition','button_delete','','en','Delete Build Revision Definition','',NULL)");
        SQLS.append(",('page_buildrevdefinition','button_delete','','fr','Supprimer la definition de build ou revision','',NULL)");
        SQLS.append(",('page_buildrevdefinition','button_edit','','en','Edit Build Revision Definition','',NULL)");
        SQLS.append(",('page_buildrevdefinition','button_edit','','fr','Editer une nouvelle definition de build ou revision','',NULL)");
        SQLS.append(",('page_buildrevdefinition','table_BuildRevision','','en','Build Revision List',NULL,NULL)");
        SQLS.append(",('page_buildrevdefinition','table_BuildRevision','','fr','Liste des Builds de Révision',NULL,NULL)");
        SQLS.append(",('page_buildrevdefinition','title','','en','BUILD REVISION DEFINITION','This page can be used to manage the definition of Builds and Revisions.','_build_revision')");
        SQLS.append(",('page_buildrevdefinition','title','','fr','DEFINITION DES BUILDS REVISIONS','Cette page permet de gérer la definition d\\'un build.','_build_revision')");
        SQLS.append(",('page_databasemaintenance','messageStatus','','en','Database is now uptodate. Enjoy the tool.',NULL,NULL)");
        SQLS.append(",('page_databasemaintenance','messageStatus','','fr','La Base de Données est à jour',NULL,NULL)");
        SQLS.append(",('page_databasemaintenance','SQLdisplay','','en','Show all SQL',NULL,NULL)");
        SQLS.append(",('page_databasemaintenance','SQLdisplay','','fr','Afficher tous les SQL',NULL,NULL)");
        SQLS.append(",('page_databasemaintenance','SQLdisplay_link','','en','here',NULL,NULL)");
        SQLS.append(",('page_databasemaintenance','SQLdisplay_link','','fr','ici',NULL,NULL)");
        SQLS.append(",('page_deploytype','button_create','','en','Create new Deployment Type','',NULL)");
        SQLS.append(",('page_deploytype','button_create','','fr','Créer un nouveau Type de Deploiement','',NULL)");
        SQLS.append(",('page_deploytype','button_delete','','en','Delete Deployment Type','',NULL)");
        SQLS.append(",('page_deploytype','button_delete','','fr','Supprimer le Type de Deploiement','',NULL)");
        SQLS.append(",('page_deploytype','button_edit','','en','Edit Deployment Type','',NULL)");
        SQLS.append(",('page_deploytype','button_edit','','fr','Modifier le Type de Deploiement','',NULL)");
        SQLS.append(",('page_deploytype','message_delete','','en','Do you want to delete Deploy Type <b>\\'%ENTRY%\\'</b> ?<br>WARNING1 : All corresponding Application will lose the link to that deleted Deploy Type !!!<br>WARNING2 : All associated Jenkins Agent on corresponding Environments will be deleted !!!','',NULL)");
        SQLS.append(",('page_deploytype','message_delete','','fr','Confirmez vous la suppression du Type de Deploiement <b>\\'%ENTRY%\\'</b> ?<br> ATTENTION1 : Toutes les Applications associées vont perdre le lien avec ce Deploy Type !!!<br>ATTENTION2 : Tous les Jenkins Agent associés et Environnements associés seront supprimés !!!','',NULL)");
        SQLS.append(",('page_deploytype','table_deploytype','','en','Deploy Type List',NULL,NULL)");
        SQLS.append(",('page_deploytype','table_deploytype','','fr','Type de Déploiement',NULL,NULL)");
        SQLS.append(",('page_deploytype','title','','en','DEPLOYMENT TYPE','This page can be used in order to manage the deployment types.','_deploy_type')");
        SQLS.append(",('page_deploytype','title','','fr','TYPE DE DEPLOIEMENT','Cette page permet de gérer et créer des types de deploiements.','_type_de_déploiement')");
        SQLS.append(",('page_environment','buttonPreviewNotification','','en','Preview Notification','',NULL)");
        SQLS.append(",('page_environment','buttonPreviewNotification','','fr','Prévisualiser la notification','',NULL)");
        SQLS.append(",('page_environment','button_create','','en','Create a new Environment','',NULL)");
        SQLS.append(",('page_environment','button_create','','fr','Créer un nouvel Environnement','',NULL)");
        SQLS.append(",('page_environment','button_delete','','en','Delete Environment','',NULL)");
        SQLS.append(",('page_environment','button_delete','','fr','Supprimer l\\'Environnement','',NULL)");
        SQLS.append(",('page_environment','button_disable','','en','Disable Environment','',NULL)");
        SQLS.append(",('page_environment','button_disable','','fr','Désactiver l\\'Environnement','',NULL)");
        SQLS.append(",('page_environment','button_disable1','','en','Disable and Send Notification','',NULL)");
        SQLS.append(",('page_environment','button_disable1','','fr','Désactiver et envoyer la Notification','',NULL)");
        SQLS.append(",('page_environment','button_edit','','en','Edit Environment','',NULL)");
        SQLS.append(",('page_environment','button_edit','','fr','Modifier l\\'Environnement','',NULL)");
        SQLS.append(",('page_environment','button_enable','','en','Enable Environment with new Build Revision','',NULL)");
        SQLS.append(",('page_environment','button_enable','','fr','Activer l\\'Environnement avec un nouveau Build et Revision','',NULL)");
        SQLS.append(",('page_environment','button_enable1','','en','Enable and Sent Notification','',NULL)");
        SQLS.append(",('page_environment','button_enable1','','fr','Activer et Envoyer la Notification','',NULL)");
        SQLS.append(",('page_environment','button_newChain','','en','New Event Chain','',NULL)");
        SQLS.append(",('page_environment','button_newChain','','fr','Nouvel Evenement de Chaine','',NULL)");
        SQLS.append(",('page_environment','button_newChain1','','en','Create New Chain Event and Send Notification','',NULL)");
        SQLS.append(",('page_environment','button_newChain1','','fr','Créer un nouvel événement de Chaine et Envoyer la Notification','',NULL)");
        SQLS.append(",('page_environment','button_view','','en','View Environment','',NULL)");
        SQLS.append(",('page_environment','button_view','','fr','Voir Environnement','',NULL)");
        SQLS.append(",('page_environment','cc','','en','CC','',NULL)");
        SQLS.append(",('page_environment','cc','','fr','Copie','',NULL)");
        SQLS.append(",('page_environment','currentBuild','','en','Current Build','',NULL)");
        SQLS.append(",('page_environment','currentBuild','','fr','Build courant','',NULL)");
        SQLS.append(",('page_environment','currentRevision','','en','Current Revision','',NULL)");
        SQLS.append(",('page_environment','currentRevision','','fr','Revision courante','',NULL)");
        SQLS.append(",('page_environment','list','','en','Environment list','',NULL)");
        SQLS.append(",('page_environment','list','','fr','Liste des environnements','',NULL)");
        SQLS.append(",('page_environment','listChange','','en','Change list','',NULL)");
        SQLS.append(",('page_environment','listChange','','fr','Liste des changements','',NULL)");
        SQLS.append(",('page_environment','listEvent','','en','Batch list','',NULL)");
        SQLS.append(",('page_environment','listEvent','','fr','Liste des batchs','',NULL)");
        SQLS.append(",('page_environment','message_delete','','en','Do you want to delete environment <b>\\'%ENVIRONMENT%\\'</b> from country <b>\\'%COUNTRY%\\'</b> and system <b>\\'%SYSTEM%\\'</b> ?<br>WARNING : All corresponding parameters such as list of applications, databases and other environments dependencies will be removed !!!','',NULL)");
        SQLS.append(",('page_environment','message_delete','','fr','Confirmez vous la suppression de l\\'environnement <b>\\'%ENVIRONMENT%\\'</b> du pays <b>\\'%COUNTRY%\\'</b> du système <b>\\'%SYSTEM%\\'</b> ?<br> ATTENTION : Tous les parametres associées tel que la liste des applications, database et autres dependances d\\'environnements seront supprimés !!!','',NULL)");
        SQLS.append(",('page_environment','newBuild','','en','New Build','',NULL)");
        SQLS.append(",('page_environment','newBuild','','fr','Nouveau Build','',NULL)");
        SQLS.append(",('page_environment','newRevision','','en','New Revision','',NULL)");
        SQLS.append(",('page_environment','newRevision','','fr','Nouvelle Revision','',NULL)");
        SQLS.append(",('page_environment','subject','','en','Subject','',NULL)");
        SQLS.append(",('page_environment','subject','','fr','Sujet','',NULL)");
        SQLS.append(",('page_environment','tabApplication','','en','Applications','',NULL)");
        SQLS.append(",('page_environment','tabApplication','','fr','Applications','',NULL)");
        SQLS.append(",('page_environment','tabBuild','','en','Build/Revision','',NULL)");
        SQLS.append(",('page_environment','tabBuild','','fr','Build/Revision','',NULL)");
        SQLS.append(",('page_environment','tabChain','','en','Chain','',NULL)");
        SQLS.append(",('page_environment','tabChain','','fr','Chain','',NULL)");
        SQLS.append(",('page_environment','tabDatabase','','en','Databases','',NULL)");
        SQLS.append(",('page_environment','tabDatabase','','fr','Bases de Données','',NULL)");
        SQLS.append(",('page_environment','tabDefinition','','en','Definition','',NULL)");
        SQLS.append(",('page_environment','tabDefinition','','fr','Definition','',NULL)");
        SQLS.append(",('page_environment','tabDependencies','','en','Dependencies','',NULL)");
        SQLS.append(",('page_environment','tabDependencies','','fr','Dépendances','',NULL)");
        SQLS.append(",('page_environment','tabDeploy','','en','Deploy Types','',NULL)");
        SQLS.append(",('page_environment','tabDeploy','','fr','Type de déploiements','',NULL)");
        SQLS.append(",('page_environment','tabInstallInstruction','','en','Installation Instructions','',NULL)");
        SQLS.append(",('page_environment','tabInstallInstruction','','fr','Instruction d\\'installation','',NULL)");
        SQLS.append(",('page_environment','tabNotif','','en','Specific Notifications','',NULL)");
        SQLS.append(",('page_environment','tabNotif','','fr','Notifications Spécifiques','',NULL)");
        SQLS.append(",('page_environment','tabPreview','','en','EMail Preview','',NULL)");
        SQLS.append(",('page_environment','tabPreview','','fr','Previsu de l\\'Email','',NULL)");
        SQLS.append(",('page_environment','title','','en','ENVIRONMENT','This page can be used to manage the environments.','_environment')");
        SQLS.append(",('page_environment','title','','fr','ENVIRONNEMENT','Cette page permet de gérer et créer des environnements.','_environnement')");
        SQLS.append(",('page_environment','to','','en','To','',NULL)");
        SQLS.append(",('page_environment','to','','fr','Destinataire','',NULL)");
        SQLS.append(",('page_executiondetail','action','','en','Action','',NULL)");
        SQLS.append(",('page_executiondetail','action','','fr','Action','',NULL)");
        SQLS.append(",('page_executiondetail','application','','en','Application','',NULL)");
        SQLS.append(",('page_executiondetail','application','','fr','Application','',NULL)");
        SQLS.append(",('page_executiondetail','browser','','en','Browser','',NULL)");
        SQLS.append(",('page_executiondetail','browser','','fr','Navigateur','',NULL)");
        SQLS.append(",('page_executiondetail','browserfull','','en','Browser full version','',NULL)");
        SQLS.append(",('page_executiondetail','browserfull','','fr','Navigateur version complete','',NULL)");
        ...
        SQLS.append(",('page_executiondetail','conditionOper','','fr','Condition Opérateur','',NULL)");
        SQLS.append(",('page_executiondetail','conditionVal1','','en','Condition Value1','',NULL)");
        SQLS.append(",('page_executiondetail','conditionVal1','','fr','Condition Value1','',NULL)");
        SQLS.append(",('page_executiondetail','conditionVal1Init','','en','Condition Value1 Initial','',NULL)");
        SQLS.append(",('page_executiondetail','conditionVal1Init','','fr','Condition Value1 Initiale','',NULL)");
        SQLS.append(",('page_executiondetail','conditionVal2','','en','Condition Value2','',NULL)");
        SQLS.append(",('page_executiondetail','conditionVal2','','fr','Condition Value2','',NULL)");
        SQLS.append(",('page_executiondetail','conditionVal2Init','','en','Condition Value2 Initial','',NULL)");
        SQLS.append(",('page_executiondetail','conditionVal2Init','','fr','Condition Value2 Initiale','',NULL)");
        SQLS.append(",('page_executiondetail','controlmessage','','en','Control Message','',NULL)");
        SQLS.append(",('page_executiondetail','controlmessage','','fr','Message du control','',NULL)");
        SQLS.append(",('page_executiondetail','controlstatus','','en','Control Status','',NULL)");
        SQLS.append(",('page_executiondetail','controlstatus','','fr','Statut','',NULL)");
        SQLS.append(",('page_executiondetail','control_type','','en','Control Type','',NULL)");
        SQLS.append(",('page_executiondetail','control_type','','fr','Type de Control','',NULL)");
        SQLS.append(",('page_executiondetail','country','','en','Country','',NULL)");
        SQLS.append(",('page_executiondetail','country','','fr','Pays','',NULL)");
        ...
        SQLS.append(",('page_executiondetail','fatal','','fr','Fatal','',NULL)");
        SQLS.append(",('page_executiondetail','finished','','en','Finished','',NULL)");
        ...
        SQLS.append(",('page_executiondetail','platform','','fr','Platforme','',NULL)");
        SQLS.append(",('page_executiondetail','port','','en','Port','',NULL)");
        ...
        SQLS.append(",('page_executiondetail','start','','en','Start','',NULL)");
        SQLS.append(",('page_executiondetail','start','','fr','Début','',NULL)");
        SQLS.append(",('page_executiondetail','status','','en','Status','',NULL)");
        SQLS.append(",('page_executiondetail','status','','fr','Status','',NULL)");
        SQLS.append(",('page_executiondetail','steps','','en','Steps','',NULL)");
        SQLS.append(",('page_executiondetail','steps','','fr','Etapes','',NULL)");
        SQLS.append(",('page_executiondetail','tag','','en','Tag','',NULL)");
        SQLS.append(",('page_executiondetail','tag','','fr','Tag','',NULL)");
        SQLS.append(",('page_executiondetail','time','','en','Time','',NULL)");
        SQLS.append(",('page_executiondetail','time','','fr','Temps','',NULL)");
        SQLS.append(",('page_executiondetail','title','','en','Execution Detail','',NULL)");
        SQLS.append(",('page_executiondetail','title','','fr','Detail de l\\'Execution','',NULL)");
        SQLS.append(",('page_executiondetail','url','','en','URL','',NULL)");
        SQLS.append(",('page_executiondetail','url','','fr','URL','',NULL)");
        SQLS.append(",('page_executiondetail','userAgent','','en','UserAgent','User Agent required for this execution',NULL)");
        SQLS.append(",('page_executiondetail','userAgent','','fr','UserAgent','User Agent envoyé au navigateur web pour cette execution',NULL)");
        SQLS.append(",('page_executiondetail','value1','','en','Value 1','',NULL)");
        SQLS.append(",('page_executiondetail','value1','','fr','Valeur 1','',NULL)");
        SQLS.append(",('page_executiondetail','value1init','','en','Value 1 Initial','',NULL)");
        SQLS.append(",('page_executiondetail','value1init','','fr','Valeur 1 Initiale','',NULL)");
        SQLS.append(",('page_executiondetail','value2','','en','Value 2','',NULL)");
        SQLS.append(",('page_executiondetail','value2','','fr','Valeur 2','',NULL)");
        SQLS.append(",('page_executiondetail','value2init','','en','Value 2 Initial','',NULL)");
        SQLS.append(",('page_executiondetail','value2init','','fr','Valeur 2 Initiale','',NULL)");
        SQLS.append(",('page_executiondetail','verbose','','en','Verbose','',NULL)");
        SQLS.append(",('page_executiondetail','verbose','','fr','Loquacité','',NULL)");
        SQLS.append(",('page_executiondetail','version','','en','Version','',NULL)");
        SQLS.append(",('page_executiondetail','version','','fr','Version','',NULL)");
        SQLS.append(",('page_executiondetail','viewExecution','','en','View Execution','',NULL)");
        SQLS.append(",('page_executiondetail','viewExecution','','fr','Voir l\\'Execution','',NULL)");
        SQLS.append(",('page_exeperbuildrevision','Days','','en','Days','Number of days with this revision for this build.',NULL)");
        SQLS.append(",('page_exeperbuildrevision','Days','','fr','Jours',NULL,NULL)");
        SQLS.append(",('page_exeperbuildrevision','NbAPP','','en','Nb Appli','Number of distinct <code class=\\'doc-crbvvoca\\'>application</code> that has been tested.',NULL)");
        SQLS.append(",('page_exeperbuildrevision','NbAPP','','fr','Nb Appli',NULL,NULL)");
        SQLS.append(",('page_exeperbuildrevision','NbExecution','','en','Exec','Number of <code class=\\'doc-crbvvoca\\'>test case</code> execution.',NULL)");
        SQLS.append(",('page_exeperbuildrevision','NbExecution','','fr','Exec',NULL,NULL)");
        SQLS.append(",('page_exeperbuildrevision','NbOK','','en','OK','Number of execution OK',NULL)");
        SQLS.append(",('page_exeperbuildrevision','NbOK','','fr','OK',NULL,NULL)");
        SQLS.append(",('page_exeperbuildrevision','NbTC','','en','Nb TC','Number of distinct <code class=\\'doc-crbvvoca\\'>test case</code> executed',NULL)");
        SQLS.append(",('page_exeperbuildrevision','NbTC','','fr','Nb CT',NULL,NULL)");
        SQLS.append(",('page_exeperbuildrevision','nb_exe_per_tc','','en','Exec/TC','Average number of execution per <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('page_exeperbuildrevision','nb_exe_per_tc','','fr','Exec/CT',NULL,NULL)");
        SQLS.append(",('page_exeperbuildrevision','nb_tc_per_day','','en','Exec/TC/Day','Number of execution per <code class=\\'doc-crbvvoca\\'>test case</code> and per day',NULL)");
        SQLS.append(",('page_exeperbuildrevision','nb_tc_per_day','','fr','Exec/Ct/Jour',NULL,NULL)");
        SQLS.append(",('page_exeperbuildrevision','OK_percentage','','en','%OK','Number of OK / number of execution',NULL)");
        SQLS.append(",('page_exeperbuildrevision','OK_percentage','','fr','%OK',NULL,NULL)");
        ...
        SQLS.append(",('page_exeperbuildrevision','RegressionExecutionStatus','','fr','Statistiques d\\'Execution en Régression',NULL,NULL)");
        ...
        SQLS.append(",('page_exeperbuildrevision','RegressionExecutionStatus1','','fr','Statistiques d\\'Execution en Régression sur des Applications Externes',NULL,NULL)");
        SQLS.append(",('page_global','beta_message','','en','This page is in beta, some features may not be available or fully functional.','',NULL)");
        SQLS.append(",('page_global','beta_message','','fr','Cette page est en beta, certaines fonctionnalités peuvent être indisponnible ou non complètes.','',NULL)");
        SQLS.append(",('page_global','btn_add','','en','Add','',NULL)");
        SQLS.append(",('page_global','btn_add','','fr','Ajouter','',NULL)");
        SQLS.append(",('page_global','btn_cancel','','en','Cancel','',NULL)");
        SQLS.append(",('page_global','btn_cancel','','fr','Annuler','',NULL)");
        SQLS.append(",('page_global','btn_clearfilter','','en','','',NULL)");
        SQLS.append(",('page_global','btn_clearfilter','','fr','','',NULL)");
        SQLS.append(",('page_global','btn_duplicate','','en','Duplicate','',NULL)");
        SQLS.append(",('page_global','btn_duplicate','','fr','Dupliquer','',NULL)");
        SQLS.append(",('page_global','btn_edit','','en','Edit',NULL,NULL)");
        SQLS.append(",('page_global','btn_edit','','fr','Editer',NULL,NULL)");
        SQLS.append(",('page_global','btn_export','','en','Export','',NULL)");
        SQLS.append(",('page_global','btn_export','','fr','Export',NULL,NULL)");
        SQLS.append(",('page_global','btn_restoreuserpreferences','','en','Load','',NULL)");
        SQLS.append(",('page_global','btn_restoreuserpreferences','','fr','Charger','',NULL)");
        SQLS.append(",('page_global','btn_savetableconfig','','en','Save','',NULL)");
        SQLS.append(",('page_global','btn_savetableconfig','','fr','Sauvegarder','',NULL)");
        SQLS.append(",('page_global','btn_showHideColumns','','en','Show/Hide','',NULL)");
        SQLS.append(",('page_global','btn_showHideColumns','','fr','Afficher/Cacher','',NULL)");
        SQLS.append(",('page_global','buttonAdd','','en','Save','',NULL)");
        SQLS.append(",('page_global','buttonAdd','','fr','Sauvegarder','',NULL)");
        SQLS.append(",('page_global','buttonClose','','en','Close','',NULL)");
        SQLS.append(",('page_global','buttonClose','','fr','Fermer','',NULL)");
        SQLS.append(",('page_global','buttonConfirm','','en','Yes','',NULL)");
        SQLS.append(",('page_global','buttonConfirm','','fr','Oui','',NULL)");
        SQLS.append(",('page_global','buttonDismiss','','en','No','',NULL)");
        SQLS.append(",('page_global','buttonDismiss','','fr','Non','',NULL)");
        SQLS.append(",('page_global','buttonLoad','','en','Load','',NULL)");
        SQLS.append(",('page_global','buttonLoad','','fr','Charger','',NULL)");
        SQLS.append(",('page_global','button_massAction','','en','Mass Action',NULL,NULL)");
        SQLS.append(",('page_global','button_massAction','','fr','Action en masse',NULL,NULL)");
        SQLS.append(",('page_global','columnAction','','en','Actions','',NULL)");
        SQLS.append(",('page_global','columnAction','','fr','Actions','',NULL)");
        SQLS.append(",('page_global','export_data','','en','Export Data','',NULL)");
        SQLS.append(",('page_global','export_data','','fr','Export de Données',NULL,NULL)");
        SQLS.append(",('page_global','filters','','en','Filters','',NULL)");
        SQLS.append(",('page_global','filters','','fr','Filtres','',NULL)");
        ...
        SQLS.append(",('page_global','lbl_all','','fr','Tous','',NULL)");
        SQLS.append(",('page_global','message_delete','','en','Do you want to delete <b>\\'%ENTRY%\\'</b> %TABLE% ?','',NULL)");
        SQLS.append(",('page_global','message_delete','','fr','Voulez vous supprimer le %TABLE% <b>\\'%ENTRY%\\'</b> ?','',NULL)");
        SQLS.append(",('page_global','message_massActionError','','en','Please select at least 1 line before trying to perform a mass action!',NULL,NULL)");
        SQLS.append(",('page_global','message_massActionError','','fr','Merci de selectionner au moins 1 élément avant de faire une action en masse !',NULL,NULL)");
        SQLS.append(",('page_global','old_page','','en','Old Page','',NULL)");
        SQLS.append(",('page_global','old_page','','fr','Ancienne Page','',NULL)");
        SQLS.append(",('page_global','processing','','en','Processing…','',NULL)");
        SQLS.append(",('page_global','processing','','fr','Traitement en cours...','',NULL)");
        SQLS.append(",('page_global','refresh','','en','Refresh',NULL,NULL)");
        SQLS.append(",('page_global','refresh','','fr','Rafraichir',NULL,NULL)");
        SQLS.append(",('page_global','tooltip_clearfilter','','en','Clear filters applied','',NULL)");
        SQLS.append(",('page_global','tooltip_clearfilter','','fr','Effacer les filtres appliqués','',NULL)");
        SQLS.append(",('page_global','tooltip_column_filter_empty','','en','Filter',NULL,NULL)");
        SQLS.append(",('page_global','tooltip_column_filter_empty','','fr','Filtre',NULL,NULL)");
        SQLS.append(",('page_global','tooltip_column_filter_filtered','','en','Filtered value(s)',NULL,NULL)");
        SQLS.append(",('page_global','tooltip_column_filter_filtered','','fr','Valeur(s) filtrée(s)',NULL,NULL)");
        SQLS.append(",('page_global','tooltip_delete_item','','en','This item will be removed from the database','',NULL)");
        SQLS.append(",('page_global','tooltip_delete_item','','fr','Cette ligne sera supprimée de la base','',NULL)");
        SQLS.append(",('page_global','tooltip_mark_remove','','en','Mark item to be removed from the database','',NULL)");
        SQLS.append(",('page_global','tooltip_mark_remove','','fr','Selectionner la ligne pour la supprimer de la base','',NULL)");
        SQLS.append(",('page_global','tooltip_massAction','','en','Select All or None to perform Mass Action',NULL,NULL)");
        SQLS.append(",('page_global','tooltip_massAction','','fr','Selectionner ou Déselectionner tous pour Action en masse',NULL,NULL)");
        SQLS.append(",('page_global','tooltip_massActionLine','','en','Select to perform Mass Action on that line',NULL,NULL)");
        SQLS.append(",('page_global','tooltip_massActionLine','','fr','Selection pour Action en masse',NULL,NULL)");
        SQLS.append(",('page_global','tooltip_restoreuserpreferences','','en','Restore the table configuration','Restore the table configuration from the user preferences. Filters and column display are available in user preferences',NULL)");
        SQLS.append(",('page_global','tooltip_restoreuserpreferences','','fr','Restaurer la configuration de la table','Restaurer la configuration de la table à partir des préférences utilisateur. Les filtres et l\\'affichage des colonnes sont chargés à partir des préférences utilisateur',NULL)");
        SQLS.append(",('page_global','tooltip_savetableconfig','','en','Save the table configuration','Save the table configuration. Filters and column display is stored in user preferences',NULL)");
        SQLS.append(",('page_global','tooltip_savetableconfig','','fr','Sauvegarder la configuration de la table','Sauvegarder la configuration de la table. Les filtres et l\\'affichage des colonnes sont sauvegardés dans les préférences utilisateur',NULL)");
        SQLS.append(",('page_global','tooltip_showHideColumns','','en','Show/hide columns','',NULL)");
        SQLS.append(",('page_global','tooltip_showHideColumns','','fr','Afficher/cacher des colonnes','',NULL)");
        SQLS.append(",('page_global','unexpected_error_message','','en','Unable to perform the task. An unexpected error has happened!','',NULL)");
        SQLS.append(",('page_global','unexpected_error_message','','fr','Impossible de finaliser l\\'operation. Une erreur inattendue est survenue','',NULL)");
        SQLS.append(",('page_global','warning','','en','Warning','',NULL)");
        SQLS.append(",('page_global','warning','','fr','Attention','',NULL)");
        SQLS.append(",('page_header','logout','','en','Logout','',NULL)");
        SQLS.append(",('page_header','logout','','fr','Déconnexion','',NULL)");
        SQLS.append(",('page_header','menuAdmin','','en','Administration','',NULL)");
        SQLS.append(",('page_header','menuAdmin','','fr','Administration','',NULL)");
        SQLS.append(",('page_header','menuApplicationObjects','','en','Application Object','',NULL)");
        SQLS.append(",('page_header','menuApplicationObjects','','fr','Objet d\\'application','',NULL)");
        SQLS.append(",('page_header','menuApplications','','en','Application','',NULL)");
        SQLS.append(",('page_header','menuApplications','','fr','Application','',NULL)");
        SQLS.append(",('page_header','menuAppService','','en','Service Library','',NULL)");
        SQLS.append(",('page_header','menuAppService','','fr','Bibliothèque de Service','',NULL)");
        SQLS.append(",('page_header','menuBatchInvariant','','en','Batch','',NULL)");
        SQLS.append(",('page_header','menuBatchInvariant','','fr','Batch','',NULL)");
        SQLS.append(",('page_header','menuBuildContent','','en','Build Content','',NULL)");
        SQLS.append(",('page_header','menuBuildContent','','fr','Contenu des Builds','',NULL)");
        SQLS.append(",('page_header','menuBuildRevision','','en','Build Revision Definition','',NULL)");
        SQLS.append(",('page_header','menuBuildRevision','','fr','Définition des Builds Revisions','',NULL)");
        SQLS.append(",('page_header','menuData','','en','Data','',NULL)");
        SQLS.append(",('page_header','menuData','','fr','Données','',NULL)");
        SQLS.append(",('page_header','menuDatabaseMaintenance','','en','Database Maintenance','',NULL)");
        SQLS.append(",('page_header','menuDatabaseMaintenance','','fr','Maintenance de la base de données','',NULL)");
        SQLS.append(",('page_header','menuDeployType','','en','Deploiement Type','',NULL)");
        SQLS.append(",('page_header','menuDeployType','','fr','Type de Déploiement','',NULL)");
        SQLS.append(",('page_header','menuDocumentation','','en','Documentation',NULL,NULL)");
        SQLS.append(",('page_header','menuDocumentation','','fr','Documentation',NULL,NULL)");
        SQLS.append(",('page_header','menuEditTest','','en','Test','',NULL)");
        SQLS.append(",('page_header','menuEditTest','','fr','Test','',NULL)");
        SQLS.append(",('page_header','menuEditTestCase','','en','Edit TestCase','',NULL)");
        SQLS.append(",('page_header','menuEditTestCase','','fr','Editer un Cas de Test','',NULL)");
        SQLS.append(",('page_header','menuEnvironmentManagement','','en','Environment Management','',NULL)");
        SQLS.append(",('page_header','menuEnvironmentManagement','','fr','Gestion des Environnements','',NULL)");
        SQLS.append(",('page_header','menuEnvironments','','en','Environment','',NULL)");
        SQLS.append(",('page_header','menuEnvironments','','fr','Environnement','',NULL)");
        SQLS.append(",('page_header','menuHelp','','en','Help',NULL,NULL)");
        SQLS.append(",('page_header','menuHelp','','fr','Aide',NULL,NULL)");
        SQLS.append(",('page_header','menuIntegration','','en','Integration','',NULL)");
        SQLS.append(",('page_header','menuIntegration','','fr','Intégration','',NULL)");
        SQLS.append(",('page_header','menuIntegrationStatus','','en','Integration Status','',NULL)");
        SQLS.append(",('page_header','menuIntegrationStatus','','fr','Etat d\\'Intégration','',NULL)");
        SQLS.append(",('page_header','menuInvariants','','en','Invariants','',NULL)");
        SQLS.append(",('page_header','menuInvariants','','fr','Invariants','',NULL)");
        SQLS.append(",('page_header','menuLabel','','en','Label','',NULL)");
        SQLS.append(",('page_header','menuLabel','','fr','Label','',NULL)");
        SQLS.append(",('page_header','menuLogViewer','','en','Log Viewer','',NULL)");
        SQLS.append(",('page_header','menuLogViewer','','fr','Log','',NULL)");
        SQLS.append(",('page_header','menuParameter','','en','Parameters','',NULL)");
        SQLS.append(",('page_header','menuParameter','','fr','Paramètres','',NULL)");
        SQLS.append(",('page_header','menuProject','','en','Project','',NULL)");
        SQLS.append(",('page_header','menuProject','','fr','Projet','',NULL)");
        SQLS.append(",('page_header','menuReportingExecutionByTag','','en','Execution Report By Tag','',NULL)");
        SQLS.append(",('page_header','menuReportingExecutionByTag','','fr','Rapport d\\'Execution par Tag','',NULL)");
        SQLS.append(",('page_header','menuReportingExecutionList','','en','Execution Report','',NULL)");
        SQLS.append(",('page_header','menuReportingExecutionList','','fr','Rapport d\\'Execution','',NULL)");
        SQLS.append(",('page_header','menuReportingExecutionThreadMonitoring','','en','Cerberus Monitoring','',NULL)");
        SQLS.append(",('page_header','menuReportingExecutionThreadMonitoring','','fr','Monitoring Cerberus','',NULL)");
        SQLS.append(",('page_header','menuRobot','','en','Robot','',NULL)");
        SQLS.append(",('page_header','menuRobot','','fr','Robot','',NULL)");
        SQLS.append(",('page_header','menuRun','','en','Run','',NULL)");
        SQLS.append(",('page_header','menuRun','','fr','Executer','',NULL)");
        SQLS.append(",('page_header','menuRunTestCase','','en','Run Test Case','',NULL)");
        SQLS.append(",('page_header','menuRunTestCase','','fr','Executer un Cas de Test','',NULL)");
        SQLS.append(",('page_header','menuRunTestSeePendingExecution','','en','Executions in queue','',NULL)");
        SQLS.append(",('page_header','menuRunTestSeePendingExecution','','fr','Fil d\\'attente d\\'éxécutions','',NULL)");
        SQLS.append(",('page_header','menuSqlLibrary','','en','SQL Library','',NULL)");
        SQLS.append(",('page_header','menuSqlLibrary','','fr','Bibliothèque de script SQL','',NULL)");
        SQLS.append(",('page_header','menuTest','','en','Test','',NULL)");
        SQLS.append(",('page_header','menuTest','','fr','Test','',NULL)");
        SQLS.append(",('page_header','menuTestBattery','','en','TestCase Battery','',NULL)");
        SQLS.append(",('page_header','menuTestBattery','','fr','Batterie de Cas de Test','',NULL)");
        SQLS.append(",('page_header','menuTestCampaign','','en','Test Campaign','',NULL)");
        SQLS.append(",('page_header','menuTestCampaign','','fr','Campagne de Test','',NULL)");
        SQLS.append(",('page_header','menuTestCase','','en','TestCase','',NULL)");
        SQLS.append(",('page_header','menuTestCase','','fr','Cas De Test','',NULL)");
        SQLS.append(",('page_header','menuTestCaseList','','en','TestCase List','',NULL)");
        SQLS.append(",('page_header','menuTestCaseList','','fr','Liste des Cas de Test','',NULL)");
        SQLS.append(",('page_header','menuTestDataLib','','en','Data Library','',NULL)");
        SQLS.append(",('page_header','menuTestDataLib','','fr','Bibliothèque de Données','',NULL)");
        SQLS.append(",('page_header','menuUsersManager','','en','User Management','',NULL)");
        SQLS.append(",('page_header','menuUsersManager','','fr','Gestion des Utilisateurs','',NULL)");
        SQLS.append(",('page_integrationstatus','DEV','','en','DEV','Nb of DEV active <code class=\\'doc-crbvvoca\\'>environments</code> on that Specific Version.',NULL)");
        SQLS.append(",('page_integrationstatus','DEV','','fr','DEV','',NULL)");
        SQLS.append(",('page_integrationstatus','environmentStatus','','en','Environment Status','',NULL)");
        SQLS.append(",('page_integrationstatus','environmentStatus','','fr','Statut des environnements','',NULL)");
        SQLS.append(",('page_integrationstatus','lastChanges','','en','Last Changes','',NULL)");
        SQLS.append(",('page_integrationstatus','lastChanges','','fr','Derniers Changements','',NULL)");
        SQLS.append(",('page_integrationstatus','PROD','','en','PROD','Nb of PROD active <code class=\\'doc-crbvvoca\\'>environments</code> on that Specific Version.',NULL)");
        SQLS.append(",('page_integrationstatus','PROD','','fr','PROD','',NULL)");
        SQLS.append(",('page_integrationstatus','QA','','en','QA','Nb of QA active <code class=\\'doc-crbvvoca\\'>environments</code> on that Specific Version.',NULL)");
        SQLS.append(",('page_integrationstatus','QA','','fr','QA','',NULL)");
        SQLS.append(",('page_integrationstatus','title','','en','INTEGRATION STATUS','',NULL)");
        SQLS.append(",('page_integrationstatus','title','','fr','ETAT D\\'INTEGRATION','',NULL)");
        SQLS.append(",('page_integrationstatus','UAT','','en','UAT','Nb of UAT active <code class=\\'doc-crbvvoca\\'>environments</code> on that Specific Version.',NULL)");
        SQLS.append(",('page_integrationstatus','UAT','','fr','UAT','',NULL)");
        SQLS.append(",('page_invariant','addinvariant_field','','en','Add Invariant','',NULL)");
        SQLS.append(",('page_invariant','addinvariant_field','','fr','Ajouter un Invariant','',NULL)");
        SQLS.append(",('page_invariant','allInvariants','','en','Invariants','',NULL)");
        SQLS.append(",('page_invariant','allInvariants','','fr','Invariants','',NULL)");
        SQLS.append(",('page_invariant','button_col','','en','Actions','',NULL)");
        SQLS.append(",('page_invariant','button_col','','fr','Actions','',NULL)");
        SQLS.append(",('page_invariant','button_create','','en','Create Invariant','',NULL)");
        SQLS.append(",('page_invariant','button_create','','fr','Créer un Invariant','',NULL)");
        SQLS.append(",('page_invariant','button_duplicate','','en','Duplicate Invariant','',NULL)");
        SQLS.append(",('page_invariant','button_duplicate','','fr','Dupliquer un Invariant','',NULL)");
        SQLS.append(",('page_invariant','button_edit','','en','Edit Invariant','',NULL)");
        SQLS.append(",('page_invariant','button_edit','','fr','Editer l\\'Invariant','',NULL)");
        SQLS.append(",('page_invariant','button_remove','','en','Delete Invariant',NULL,NULL)");
        SQLS.append(",('page_invariant','button_remove','','fr','Supprimer l\\'Invariant',NULL,NULL)");
        SQLS.append(",('page_invariant','description','','en','Description','',NULL)");
        SQLS.append(",('page_invariant','description','','fr','Description','',NULL)");
        SQLS.append(",('page_invariant','editinvariant_field','','en','Edit Invariant','',NULL)");
        SQLS.append(",('page_invariant','editinvariant_field','','fr','Editer un Invariant','',NULL)");
        SQLS.append(",('page_invariant','gp1','','en','Group 1','',NULL)");
        SQLS.append(",('page_invariant','gp1','','fr','Groupe 1','',NULL)");
        SQLS.append(",('page_invariant','gp2','','en','Group 2','',NULL)");
        SQLS.append(",('page_invariant','gp2','','fr','Groupe 2','',NULL)");
        SQLS.append(",('page_invariant','gp3','','en','Group 3','',NULL)");
        SQLS.append(",('page_invariant','gp3','','fr','Groupe 3','',NULL)");
        SQLS.append(",('page_invariant','gp4','','en','Group 4','',NULL)");
        SQLS.append(",('page_invariant','gp4','','fr','Groupe 4','',NULL)");
        SQLS.append(",('page_invariant','gp5','','en','Group 5','',NULL)");
        SQLS.append(",('page_invariant','gp5','','fr','Groupe 5','',NULL)");
        SQLS.append(",('page_invariant','gp6','','en','Group 6','',NULL)");
        SQLS.append(",('page_invariant','gp6','','fr','Groupe 6','',NULL)");
        SQLS.append(",('page_invariant','gp7','','en','Group 7','',NULL)");
        SQLS.append(",('page_invariant','gp7','','fr','Groupe 7','',NULL)");
        SQLS.append(",('page_invariant','gp8','','en','Group 8','',NULL)");
        SQLS.append(",('page_invariant','gp8','','fr','Groupe 8','',NULL)");
        SQLS.append(",('page_invariant','gp9','','en','Group 9','',NULL)");
        SQLS.append(",('page_invariant','gp9','','fr','Groupe 9','',NULL)");
        SQLS.append(",('page_invariant','idname','','en','IdName','',NULL)");
        SQLS.append(",('page_invariant','idname','','fr','IdName','',NULL)");
        SQLS.append(",('page_invariant','message_remove','','en','Are you sure?','',NULL)");
        ...
        SQLS.append(",('page_invariant','title_remove','','en','Delete an Invariant','',NULL)");
        SQLS.append(",('page_invariant','title_remove','','fr','Supprimer un Invariant','',NULL)");
        SQLS.append(",('page_invariant','value','','en','Value','',NULL)");
        SQLS.append(",('page_invariant','value','','fr','Valeur','',NULL)");
        SQLS.append(",('page_invariant','veryShortDesc','','en','Very Short Description','',NULL)");
        SQLS.append(",('page_invariant','veryShortDesc','','fr','Petite Description','',NULL)");
        SQLS.append(",('page_label','btn_create','','en','Create Label','',NULL)");
        SQLS.append(",('page_label','btn_create','','fr','Créer un Label','',NULL)");
        SQLS.append(",('page_label','btn_delete','','en','Delete Label','',NULL)");
        SQLS.append(",('page_label','btn_delete','','fr','Effacer le Label','',NULL)");
        SQLS.append(",('page_label','btn_edit','','en','Edit Label','',NULL)");
        SQLS.append(",('page_label','btn_edit','','fr','Editer le Label','',NULL)");
        SQLS.append(",('page_label','btn_view','','en','View Label','',NULL)");
        ...
        SQLS.append(",('page_logviewer','button_view','','fr','Detail du log','',NULL)");
        SQLS.append(",('page_logviewer','table_logviewer','','en','Log Viewer',NULL,NULL)");
        SQLS.append(",('page_logviewer','table_logviewer','','fr','Liste des Modifications',NULL,NULL)");
        SQLS.append(",('page_logviewer','title','','en','LOG VIEWER','This page displays all the log messages from Cerberus.','_log_viewer')");
        SQLS.append(",('page_logviewer','title','','fr','JOURNAL DE MODIFICATIONS','Cette page affiche tout les messages de log de Cerberus.','_journal_de_modifications')");
        SQLS.append(",('page_notification','Body','','en','Body','',NULL)");
        SQLS.append(",('page_notification','Body','','fr','Corps',NULL,NULL)");
        SQLS.append(",('page_notification','Cc','','en','Copy','',NULL)");
        SQLS.append(",('page_notification','Subject','','en','Subject','',NULL)");
        SQLS.append(",('page_notification','To','','en','To','',NULL)");
        SQLS.append(",('page_parameter','allParameters','','en','Parameters','',NULL)");
        SQLS.append(",('page_parameter','allParameters','','fr','Paramètres','',NULL)");
        SQLS.append(",('page_parameter','button_col','','en','Actions','',NULL)");
        SQLS.append(",('page_parameter','button_col','','fr','Actions','',NULL)");
        SQLS.append(",('page_parameter','button_edit','','en','Edit Parameter','',NULL)");
        SQLS.append(",('page_parameter','button_edit','','fr','Editer le parmètre','',NULL)");
        SQLS.append(",('page_parameter','cerberus_col','','en','Cerberus Value','',NULL)");
        SQLS.append(",('page_parameter','cerberus_col','','fr','Valeur de Cerberus','',NULL)");
        SQLS.append(",('page_parameter','cerberus_field','','en','Cerberus Value','',NULL)");
        SQLS.append(",('page_parameter','cerberus_field','','fr','Valeur de Cerberus','',NULL)");
        SQLS.append(",('page_parameter','close_btn','','en','Close','',NULL)");
        SQLS.append(",('page_parameter','close_btn','','fr','Fermer','',NULL)");
        SQLS.append(",('page_parameter','description_col','','en','Description','',NULL)");
        SQLS.append(",('page_parameter','description_col','','fr','Description','',NULL)");
        SQLS.append(",('page_parameter','description_field','','en','Description','',NULL)");
        SQLS.append(",('page_parameter','description_field','','fr','Description','',NULL)");
        SQLS.append(",('page_parameter','editparameter_field','','en','Edit Parameter','',NULL)");
        SQLS.append(",('page_parameter','editparameter_field','','fr','Modifier le paramètre','',NULL)");
        SQLS.append(",('page_parameter','parameter_col','','en','Parameter','',NULL)");
        SQLS.append(",('page_parameter','parameter_col','','fr','Paramètre','',NULL)");
        SQLS.append(",('page_parameter','parameter_field','','en','Parameter','',NULL)");
        SQLS.append(",('page_parameter','parameter_field','','fr','Paramètre','',NULL)");
        SQLS.append(",('page_parameter','save_btn','','en','Save','',NULL)");
        SQLS.append(",('page_parameter','save_btn','','fr','Sauvegarder','',NULL)");
        SQLS.append(",('page_parameter','system_col','','en','System Value','',NULL)");
        SQLS.append(",('page_parameter','system_col','','fr','Valeur du système','',NULL)");
        SQLS.append(",('page_parameter','system_field','','en','System Value','',NULL)");
        SQLS.append(",('page_parameter','system_field','','fr','Valeur du Système','',NULL)");
        SQLS.append(",('page_parameter','table_parameter','','en','Parameter',NULL,NULL)");
        SQLS.append(",('page_parameter','table_parameter','','fr','Paramètres',NULL,NULL)");
        SQLS.append(",('page_project','button_create','','en','Create new Project','',NULL)");
        SQLS.append(",('page_project','button_create','','fr','Créer un nouveau Projet','',NULL)");
        SQLS.append(",('page_project','button_delete','','en','Delete Project','',NULL)");
        SQLS.append(",('page_project','button_delete','','fr','Supprimer le Projet','',NULL)");
        SQLS.append(",('page_project','button_edit','','en','Edit Project','',NULL)");
        SQLS.append(",('page_project','button_edit','','fr','Modifier le Projet','',NULL)");
        SQLS.append(",('page_project','message_delete','','en','Do you want to delete Project <b>\\'%ENTRY%\\'</b> ?<br>WARNING : All corresponding Test Cases will lose the link to that deleted Project !!!','',NULL)");
        SQLS.append(",('page_project','message_delete','','fr','Confirmez vous la suppression du projet <b>\\'%ENTRY%\\'</b> ?<br> ATTENTION : Tous les Cas de Tests associés vont perdre le lien avec ce projet !!!','',NULL)");
        SQLS.append(",('page_project','table_project','','en','Project List',NULL,NULL)");
        SQLS.append(",('page_project','table_project','','fr','Liste des Projets',NULL,NULL)");
        SQLS.append(",('page_project','title','','en','PROJECT','This page can be used in order to manage the projets.','_project')");
        SQLS.append(",('page_project','title','','fr','PROJET','Cette page permet de gérer et créer des projets.','_projet')");
        SQLS.append(",('page_reportbytag','btn_select_table','','en','Select table','',NULL)");
        SQLS.append(",('page_reportbytag','btn_select_table','','fr','Select de la table',NULL,NULL)");
        SQLS.append(",('page_reportbytag','button_load','','en','Load','',NULL)");
        SQLS.append(",('page_reportbytag','button_load','','fr','Charger','',NULL)");
        SQLS.append(",('page_reportbytag','button_reload','','en','Reload','',NULL)");
        ...
        SQLS.append(",('page_reportbytag','report_list','','fr','Liste','Une liste de toute les executions de cas de test par environnement, pays et navigateur',NULL)");
        SQLS.append(",('page_reportbytag','report_status','','en','Report by Status','A report containing the number of execution for each status with their percentage and a chart associated',NULL)");
        SQLS.append(",('page_reportbytag','report_status','','fr','Rapport par Status','Rapport contenant le nombre d\\'execution pour chaque status avec leur pourcentage et un graphique associé',NULL)");
        SQLS.append(",('page_reportbytag','summary_table','','en','Summary Table','Summary of the total and percentages values for each result code (OK, KO, FA, NA, NE, PE, CA). Table is sorted by Application, Country and Environment.',NULL)");
        SQLS.append(",('page_reportbytag','summary_table','','fr','Résumé de la table',NULL,NULL)");
        SQLS.append(",('page_reportbytag','title','','en','Execution reporting by tag','This page generate a report of all the execution for a choosen tag',NULL)");
        SQLS.append(",('page_reportbytag','title','','fr','Rapport d\\'execution par Tag','Cette page génère un rapport de toutes les executions pour un tag choisi',NULL)");
        SQLS.append(",('page_robot','button_create','','en','Create new Robot','',NULL)");
        SQLS.append(",('page_robot','button_create','','fr','Créer un nouveau Robot','',NULL)");
        SQLS.append(",('page_robot','button_delete','','en','Delete Robot','',NULL)");
        SQLS.append(",('page_robot','button_delete','','fr','Supprimer le Robot','',NULL)");
        SQLS.append(",('page_robot','button_edit','','en','Edit Robot','',NULL)");
        SQLS.append(",('page_robot','button_edit','','fr','Modifier le Robot','',NULL)");
        SQLS.append(",('page_robot','table_robotlist','','en','Robot List',NULL,NULL)");
        SQLS.append(",('page_robot','table_robotlist','','fr','Liste des Robots',NULL,NULL)");
        SQLS.append(",('page_robot','title','','en','ROBOT','This page can be used in order to manage the robots.','_robot')");
        SQLS.append(",('page_robot','title','','fr','ROBOT','Cette page permet de gérer et créer des Robots.','_robot')");
        SQLS.append(",('page_runtest','addtoqueue','','en','Add to queue','',NULL)");
        SQLS.append(",('page_runtest','addtoqueue','','fr','Ajouter à la liste','',NULL)");
        SQLS.append(",('page_runtest','addtoqueueandrun','','en','Add to queue and run','',NULL)");
        SQLS.append(",('page_runtest','addtoqueueandrun','','fr','Ajouter à la liste et executer','',NULL)");
        SQLS.append(",('page_runtest','application','','en','Application','',NULL)");
        SQLS.append(",('page_runtest','application','','fr','Application','',NULL)");
        SQLS.append(",('page_runtest','automatic','','en','Automatic','',NULL)");
        SQLS.append(",('page_runtest','automatic','','fr','Automatique','',NULL)");
        SQLS.append(",('page_runtest','browser','','en','Browser','',NULL)");
        SQLS.append(",('page_runtest','browser','','fr','Navigateur','',NULL)");
        SQLS.append(",('page_runtest','campaign','','en','Campaign','',NULL)");
        SQLS.append(",('page_runtest','campaign','','fr','Campagne','',NULL)");
        SQLS.append(",('page_runtest','ChooseTest','','en','Choose Test Case / Environment / Country','',NULL)");
        SQLS.append(",('page_runtest','ChooseTest','','fr','Selectionner Cas de test / Environnement / Pays','',NULL)");
        SQLS.append(",('page_runtest','choose_test','','en','Choose Test','',NULL)");
        SQLS.append(",('page_runtest','choose_test','','fr','Sélectionner vos test','',NULL)");
        SQLS.append(",('page_runtest','countryList','','en','Country :','',NULL)");
        SQLS.append(",('page_runtest','countryList','','fr','Liste de pays :','',NULL)");
        SQLS.append(",('page_runtest','creator','','en','Creator','',NULL)");
        SQLS.append(",('page_runtest','creator','','fr','Créateur','',NULL)");
        SQLS.append(",('page_runtest','custom_config','','en','-- Custom Configuration --','',NULL)");
        SQLS.append(",('page_runtest','custom_config','','fr','-- Configuration personnalisée --','',NULL)");
        SQLS.append(",('page_runtest','default','','en','Default','',NULL)");
        SQLS.append(",('page_runtest','default','','fr','Defaut','',NULL)");
        SQLS.append(",('page_runtest','default_full_screen','','en','Default - Full Screen','',NULL)");
        SQLS.append(",('page_runtest','default_full_screen','','fr','Defaut - Plein Ecran','',NULL)");
        SQLS.append(",('page_runtest','empty_queue','','en','The Execution Queue is empty !','',NULL)");
        SQLS.append(",('page_runtest','empty_queue','','fr','La liste d\\'execution est vide !','',NULL)");
        SQLS.append(",('page_runtest','envList','','en','Environment :',NULL,NULL)");
        SQLS.append(",('page_runtest','envList','','fr','Environnement : ',NULL,NULL)");
        SQLS.append(",('page_runtest','execution_settings','','en','Execution Settings','',NULL)");
        SQLS.append(",('page_runtest','execution_settings','','fr','Paramètres d\\'execution','',NULL)");
        SQLS.append(",('page_runtest','filters','','en','Extended Test Case Filters','',NULL)");
        SQLS.append(",('page_runtest','filters','','fr','Filtres Cas de test','',NULL)");
        SQLS.append(",('page_runtest','group','','en','Group','',NULL)");
        SQLS.append(",('page_runtest','group','','fr','Groupe','',NULL)");
        SQLS.append(",('page_runtest','implementer','','en','Implementer','',NULL)");
        SQLS.append(",('page_runtest','implementer','','fr','Implementeur','',NULL)");
        SQLS.append(",('page_runtest','load','','en','Load','',NULL)");
        SQLS.append(",('page_runtest','load','','fr','Charger','',NULL)");
        SQLS.append(",('page_runtest','manual','','en','Manual','',NULL)");
        SQLS.append(",('page_runtest','manual','','fr','Manuel','',NULL)");
        SQLS.append(",('page_runtest','manual_execution','','en','Manual Execution','',NULL)");
        SQLS.append(",('page_runtest','manual_execution','','fr','Execution Manuelle','',NULL)");
        SQLS.append(",('page_runtest','more_than_one_execution_requested','','en','More than 1 excution and no Tag specified','',NULL)");
        SQLS.append(",('page_runtest','more_than_one_execution_requested','','fr','Plus d\\'une execution séléctionnées et aucun tag n\\'a été spécifié','',NULL)");
        ...
        SQLS.append(",('page_runtest','myloginrelativeurl','','fr','Mon url de login relative','',NULL)");
        SQLS.append(",('page_runtest','notValid','','en','Some executions couldn\\'t be added to the queue','',NULL)");
        SQLS.append(",('page_runtest','notValid','','fr','Des executions n\\'ont pas pu être ajoutées à la liste','',NULL)");
        SQLS.append(",('page_runtest','outputformat','','en','Output Format','',NULL)");
        SQLS.append(",('page_runtest','outputformat','','fr','Format de sortie','',NULL)");
        SQLS.append(",('page_runtest','pagesource','','en','Page Source','',NULL)");
        SQLS.append(",('page_runtest','pagesource','','fr','Page Source','',NULL)");
        SQLS.append(",('page_runtest','platform','','en','Platform','',NULL)");
        SQLS.append(",('page_runtest','platform','','fr','Plateforme','',NULL)");
        SQLS.append(",('page_runtest','potential','','en','Potential','',NULL)");
        SQLS.append(",('page_runtest','potential','','fr','Potentiel','',NULL)");
        SQLS.append(",('page_runtest','priority','','en','Priority','',NULL)");
        SQLS.append(",('page_runtest','priority','','fr','Priorité','',NULL)");
        SQLS.append(",('page_runtest','project','','en','Project','',NULL)");
        SQLS.append(",('page_runtest','project','','fr','Projet','',NULL)");
        SQLS.append(",('page_runtest','queue','','en','Queue','',NULL)");
        SQLS.append(",('page_runtest','queue','','fr','Liste','',NULL)");
        SQLS.append(",('page_runtest','reset_queue','','en','Reset queue','',NULL)");
        SQLS.append(",('page_runtest','reset_queue','','fr','Vider la liste','',NULL)");
        SQLS.append(",('page_runtest','retries','','en','Retries','',NULL)");
        SQLS.append(",('page_runtest','retries','','fr','Essais','',NULL)");
        SQLS.append(",('page_runtest','robot_settings','','en','Robot Settings','',NULL)");
        SQLS.append(",('page_runtest','robot_settings','','fr','Paramètres du Robot','',NULL)");
        SQLS.append(",('page_runtest','run','','en','Run','',NULL)");
        SQLS.append(",('page_runtest','run','','fr','Executer','',NULL)");
        SQLS.append(",('page_runtest','saverobotpref','','en','Save Robot Preferencies','',NULL)");
        SQLS.append(",('page_runtest','saverobotpref','','fr','Enregistrer les préférences du robot','',NULL)");
        SQLS.append(",('page_runtest','save_execution_params','','en','Save Execution Parameters','',NULL)");
        SQLS.append(",('page_runtest','save_execution_params','','fr','Sauvegarder les paramètres d\\'execution','',NULL)");
        SQLS.append(",('page_runtest','screenshot','','en','Screenshot','',NULL)");
        SQLS.append(",('page_runtest','screenshot','','fr','Screenshot','',NULL)");
        SQLS.append(",('page_runtest','screensize','','en','Screen size','',NULL)");
        SQLS.append(",('page_runtest','screensize','','fr','Taille d\\'écran','',NULL)");
        SQLS.append(",('page_runtest','selection_type','','en','Selection type','',NULL)");
        SQLS.append(",('page_runtest','selection_type','','fr','Type de selection','',NULL)");
        SQLS.append(",('page_runtest','select_all','','en','Select All','',NULL)");
        SQLS.append(",('page_runtest','select_all','','fr','Tout Sélectionner','',NULL)");
        SQLS.append(",('page_runtest','select_campaign','','en','Select a campaign','',NULL)");
        SQLS.append(",('page_runtest','select_campaign','','fr','Sélectionner une campagne','',NULL)");
        SQLS.append(",('page_runtest','select_list_test','','en','Select a list of test','',NULL)");
        SQLS.append(",('page_runtest','select_list_test','','fr','Sélectionner une list de test','',NULL)");
        ...
        SQLS.append(",('page_runtest','select_robot','','fr','Sélectionner un robot','',NULL)");
        SQLS.append(",('page_runtest','seleniumlog','','en','Selenium Log','',NULL)");
        SQLS.append(",('page_runtest','seleniumlog','','fr','Log de Selenium','',NULL)");
        SQLS.append(",('page_runtest','selenium_ip','','en','Selenium Server IP','',NULL)");
        SQLS.append(",('page_runtest','selenium_ip','','fr','IP du serveur Selenium','',NULL)");
        SQLS.append(",('page_runtest','selenium_port','','en','Selenium Server Port','',NULL)");
        SQLS.append(",('page_runtest','selenium_port','','fr','Port du serveur Selenium','',NULL)");
        SQLS.append(",('page_runtest','size','','en','Size','',NULL)");
        SQLS.append(",('page_runtest','size','','fr','Taille','',NULL)");
        SQLS.append(",('page_runtest','status','','en','Status','',NULL)");
        SQLS.append(",('page_runtest','status','','fr','Status','',NULL)");
        SQLS.append(",('page_runtest','synchroneous','','en','Synchroneous','',NULL)");
        SQLS.append(",('page_runtest','synchroneous','','fr','Synchrone','',NULL)");
        SQLS.append(",('page_runtest','tag','','en','Tag','',NULL)");
        SQLS.append(",('page_runtest','tag','','fr','Tag','',NULL)");
        SQLS.append(",('page_runtest','targetrev','','en','Target Revision','',NULL)");
        SQLS.append(",('page_runtest','targetrev','','fr','Révision Cible','',NULL)");
        SQLS.append(",('page_runtest','targetsprint','','en','Target Sprint','',NULL)");
        SQLS.append(",('page_runtest','targetsprint','','fr','Sprint Cible','',NULL)");
        SQLS.append(",('page_runtest','test','','en','Test','',NULL)");
        SQLS.append(",('page_runtest','test','','fr','Test','',NULL)");
        SQLS.append(",('page_runtest','testbattery','','en','Test Battery','',NULL)");
        SQLS.append(",('page_runtest','testbattery','','fr','Batterie de test','',NULL)");
        SQLS.append(",('page_runtest','testcaseList','','en','Test Case :',NULL,NULL)");
        SQLS.append(",('page_runtest','testcaseList','','fr','Cas de Test : ',NULL,NULL)");
        SQLS.append(",('page_runtest','timeout','','en','Timeout','',NULL)");
        SQLS.append(",('page_runtest','timeout','','fr','Temporisation','',NULL)");
        SQLS.append(",('page_runtest','title','','en','Run Test','',NULL)");
        SQLS.append(",('page_runtest','title','','fr','Executer un test','',NULL)");
        SQLS.append(",('page_runtest','valid','','en','Executions in queue','',NULL)");
        SQLS.append(",('page_runtest','valid','','fr','Executions dans la liste','',NULL)");
        SQLS.append(",('page_runtest','verbose','','en','Verbose','',NULL)");
        SQLS.append(",('page_runtest','verbose','','fr','Loquacité','',NULL)");
        SQLS.append(",('page_runtest','version','','en','Version','',NULL)");
        SQLS.append(",('page_runtest','version','','fr','Version','',NULL)");
        ...
        SQLS.append(",('page_runtests','manualExecution','','en','ManualExecution','Manual Execution is the way to execute the <code class=\\'doc-crbvvoca\\'>test case</code>. It could be YES to manually execute all kind of <code class=\\'doc-crbvvoca\\'>test case</code>, or NO to execute if automatically.',NULL)");
        SQLS.append(",('page_runtests','manualExecution','','fr','Execution manuelle',NULL,NULL)");
        ...
        SQLS.append(",('page_runtests','SeleniumServerIP','','en','Selenium Server IP','Selenium Server IP is the IP of the computer where the selenium server is running.<br>This also correspond to the IP where the brower will execute the <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('page_runtests','SeleniumServerIP','','fr','IP du serveur Selenium',NULL,NULL)");
        SQLS.append(",('page_runtests','SeleniumServerPort','','en','Selenium Server Port','Selenium Server Port is the port which will be used to run the <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('page_runtests','SeleniumServerPort','','fr','Port du serveur Selenium',NULL,NULL)");
        SQLS.append(",('page_runtests','Synchroneous','','en','Synchroneous','This is parameter to define if user mut be redirected to the reporting during the execution.<br><br>By default, synchroneous will be set to Y, meaning the redirection will be at the end of the execution.',NULL)");
        SQLS.append(",('page_runtests','Timeout','','en','Timeout','This is the timeout used for the execution.<br><br>If empty, the default value will be the one set in the parameter table.',NULL)");
        SQLS.append(",('page_sqlLibrary','addSqlLibrary_field','','en','Add Library','',NULL)");
        SQLS.append(",('page_sqlLibrary','addSqlLibrary_field','','fr','Ajouter une librairie','',NULL)");
        SQLS.append(",('page_sqlLibrary','allSqlLibrarys','','en','SQL Libraries','',NULL)");
        SQLS.append(",('page_sqlLibrary','allSqlLibrarys','','fr','Librairies SQL','',NULL)");
        SQLS.append(",('page_sqlLibrary','button_col','','en','Actions','',NULL)");
        SQLS.append(",('page_sqlLibrary','button_col','','fr','Actions','',NULL)");
        SQLS.append(",('page_sqlLibrary','button_create','','en','Add Library','',NULL)");
        SQLS.append(",('page_sqlLibrary','button_create','','fr','Ajouter une librairie','',NULL)");
        SQLS.append(",('page_sqlLibrary','button_edit','','en','Edit Library','',NULL)");
        SQLS.append(",('page_sqlLibrary','button_edit','','fr','Editer la librairie','',NULL)");
        SQLS.append(",('page_sqlLibrary','button_remove','','en','Delete Library','',NULL)");
        SQLS.append(",('page_sqlLibrary','button_remove','','fr','Supprimer la librairie','',NULL)");
        SQLS.append(",('page_sqlLibrary','close_btn','','en','Close','',NULL)");
        SQLS.append(",('page_sqlLibrary','close_btn','','fr','Fermer','',NULL)");
        SQLS.append(",('page_sqlLibrary','database_col','','en','Database','',NULL)");
        SQLS.append(",('page_sqlLibrary','database_col','','fr','Base de donnée','',NULL)");
        SQLS.append(",('page_sqlLibrary','database_field','','en','Database','',NULL)");
        SQLS.append(",('page_sqlLibrary','database_field','','fr','Base de donnée','',NULL)");
        SQLS.append(",('page_sqlLibrary','description_col','','en','Description','',NULL)");
        SQLS.append(",('page_sqlLibrary','description_col','','fr','Description','',NULL)");
        SQLS.append(",('page_sqlLibrary','description_field','','en','Description','',NULL)");
        SQLS.append(",('page_sqlLibrary','description_field','','fr','Description','',NULL)");
        SQLS.append(",('page_sqlLibrary','editSqlLibrary_field','','en','Edit Library','',NULL)");
        SQLS.append(",('page_sqlLibrary','editSqlLibrary_field','','fr','Editer la librairie','',NULL)");
        SQLS.append(",('page_sqlLibrary','idname_field','','en','Name','',NULL)");
        SQLS.append(",('page_sqlLibrary','idname_field','','fr','Nom','',NULL)");
        SQLS.append(",('page_sqlLibrary','message_remove','','en','Are you sure?','',NULL)");
        SQLS.append(",('page_sqlLibrary','message_remove','','fr','Êtes-vous sûrs?','',NULL)");
        SQLS.append(",('page_sqlLibrary','save_btn','','en','Save Library','',NULL)");
        SQLS.append(",('page_sqlLibrary','save_btn','','fr','Sauvegarder la librairie','',NULL)");
        SQLS.append(",('page_sqlLibrary','script_col','','en','Script','',NULL)");
        SQLS.append(",('page_sqlLibrary','script_col','','fr','Script','',NULL)");
        SQLS.append(",('page_sqlLibrary','script_field','','en','Script','',NULL)");
        SQLS.append(",('page_sqlLibrary','script_field','','fr','Script','',NULL)");
        SQLS.append(",('page_sqlLibrary','sqlLibrary','','en','SQL Library','',NULL)");
        SQLS.append(",('page_sqlLibrary','sqlLibrary','','fr','Librairie SQL','',NULL)");
        SQLS.append(",('page_sqlLibrary','sqlLibrary_col','','en','Name','',NULL)");
        SQLS.append(",('page_sqlLibrary','sqlLibrary_col','','fr','Nom','',NULL)");
        SQLS.append(",('page_sqlLibrary','sqlLibrary_field','','en','SQL Librairy','',NULL)");
        SQLS.append(",('page_sqlLibrary','sqlLibrary_field','','fr','Librairie SQL','',NULL)");
        SQLS.append(",('page_sqlLibrary','title_remove','','en','Delete Library','',NULL)");
        SQLS.append(",('page_sqlLibrary','title_remove','','fr','Supprimer la librairie','',NULL)");
        SQLS.append(",('page_sqlLibrary','type_col','','en','Type','',NULL)");
        SQLS.append(",('page_sqlLibrary','type_col','','fr','Type','',NULL)");
        SQLS.append(",('page_sqlLibrary','type_field','','en','Type','',NULL)");
        SQLS.append(",('page_sqlLibrary','type_field','','fr','Type','',NULL)");
        SQLS.append(",('page_test','btn_create','','en','Create Test','',NULL)");
        SQLS.append(",('page_test','btn_create','','fr','Créer un Test','',NULL)");
        SQLS.append(",('page_test','btn_edit','','en','Edit Test','',NULL)");
        SQLS.append(",('page_test','btn_edit','','fr','Modifier le Test','',NULL)");
        SQLS.append(",('page_test','btn_tclist','','en','Go To TestCase List','',NULL)");
        SQLS.append(",('page_test','btn_tclist','','fr','Aller à la page des Cas de Test','',NULL)");
        SQLS.append(",('page_test','button_delete','','en','Delete Test','',NULL)");
        SQLS.append(",('page_test','button_delete','','fr','Supprimer le Test','',NULL)");
        SQLS.append(",('page_test','delete','','en','Dlt','Select this checkbox and then save changes in order to delete the row.',NULL)");
        SQLS.append(",('page_test','message_delete','','en','Do you want to delete Test <b>\\'%ENTRY%\\'</b> ?<br>WARNING : All corresponding Test Cases will be removed as well !!!','',NULL)");
        SQLS.append(",('page_test','message_delete','','fr','Confirmez vous la suppression du Test <b>\\'%ENTRY%\\'</b> ?<br> ATTENTION : Tous les Cas de Test associés seront également supprimés !!!','',NULL)");
        SQLS.append(",('page_test','table_testlist','','en','Test List',NULL,NULL)");
        SQLS.append(",('page_test','table_testlist','','fr','Liste de Tests',NULL,NULL)");
        SQLS.append(",('page_testbattery','addtestbattery_field','','en','Add Battery','',NULL)");
        SQLS.append(",('page_testbattery','addtestbattery_field','','fr','Ajouter la Batterie','',NULL)");
        SQLS.append(",('page_testbattery','addtestcase_tab','','en','Add Test Case','',NULL)");
        SQLS.append(",('page_testbattery','addtestcase_tab','','fr','Ajouter un cas de test','',NULL)");
        SQLS.append(",('page_testbattery','add_btn','','en','Add','',NULL)");
        SQLS.append(",('page_testbattery','add_btn','','fr','Ajouter','',NULL)");
        SQLS.append(",('page_testbattery','allTestbatterys','','en','Test Battery','',NULL)");
        SQLS.append(",('page_testbattery','allTestbatterys','','fr','Batterie de Test','',NULL)");
        SQLS.append(",('page_testbattery','back_btn','','en','Back','',NULL)");
        SQLS.append(",('page_testbattery','back_btn','','fr','Précédent','',NULL)");
        SQLS.append(",('page_testbattery','battery_field','','en','Battery','',NULL)");
        SQLS.append(",('page_testbattery','battery_field','','fr','Batterie','',NULL)");
        SQLS.append(",('page_testbattery','button_add','','en','Add Test Case','',NULL)");
        SQLS.append(",('page_testbattery','button_add','','fr','Ajouter un Cas de Test','',NULL)");
        SQLS.append(",('page_testbattery','button_col','','en','Actions','',NULL)");
        SQLS.append(",('page_testbattery','button_col','','fr','Actions','',NULL)");
        SQLS.append(",('page_testbattery','button_create','','en','Create Battery','',NULL)");
        SQLS.append(",('page_testbattery','button_create','','fr','Créer une Batterie','',NULL)");
        SQLS.append(",('page_testbattery','button_edit','','en','Edit Battery','',NULL)");
        SQLS.append(",('page_testbattery','button_edit','','fr','Editer la Batterie','',NULL)");
        SQLS.append(",('page_testbattery','button_remove','','en','Delete Battery','',NULL)");
        SQLS.append(",('page_testbattery','button_remove','','fr','Supprimer la Batterie','',NULL)");
        SQLS.append(",('page_testbattery','close_btn','','en','Close','',NULL)");
        SQLS.append(",('page_testbattery','close_btn','','fr','Fermer','',NULL)");
        SQLS.append(",('page_testbattery','description_col','','en','Description','',NULL)");
        SQLS.append(",('page_testbattery','description_col','','fr','Description','',NULL)");
        SQLS.append(",('page_testbattery','description_field','','en','Description','',NULL)");
        SQLS.append(",('page_testbattery','description_field','','fr','Description','',NULL)");
        SQLS.append(",('page_testbattery','description_tab','','en','Description','',NULL)");
        SQLS.append(",('page_testbattery','description_tab','','fr','Description','',NULL)");
        SQLS.append(",('page_testbattery','edittestbattery_field','','en','Edit Battery','',NULL)");
        SQLS.append(",('page_testbattery','edittestbattery_field','','fr','Modifier la Batterie','',NULL)");
        SQLS.append(",('page_testbattery','message_remove','','en','Are you sure to delete the battery ?','',NULL)");
        SQLS.append(",('page_testbattery','message_remove','','fr','Êtes-vous sûrs de supprimer la batterie ?','',NULL)");
        SQLS.append(",('page_testbattery','save_btn','','en','Save','',NULL)");
        SQLS.append(",('page_testbattery','save_btn','','fr','Sauvegarder','',NULL)");
        SQLS.append(",('page_testbattery','table_testbattery','','en','Batterie de Test',NULL,NULL)");
        SQLS.append(",('page_testbattery','table_testbattery','','fr','Batterie de Test',NULL,NULL)");
        SQLS.append(",('page_testbattery','testbattery_col','','en','Test Battery','',NULL)");
        SQLS.append(",('page_testbattery','testbattery_col','','fr','Batterie de test','',NULL)");
        SQLS.append(",('page_testbattery','testcampaign_col','','en','Test Battery','',NULL)");
        SQLS.append(",('page_testbattery','testcampaign_col','','fr','Batterie de test','',NULL)");
        SQLS.append(",('page_testbattery','testcase_col','','en','Test Case ID','',NULL)");
        SQLS.append(",('page_testbattery','testcase_col','','fr','ID du Cas de Test','',NULL)");
        SQLS.append(",('page_testbattery','testcase_tab','','en','Test Case','',NULL)");
        SQLS.append(",('page_testbattery','testcase_tab','','fr','Cas de test','',NULL)");
        SQLS.append(",('page_testbattery','test_col','','en','Test','',NULL)");
        SQLS.append(",('page_testbattery','test_col','','fr','Test','',NULL)");
        SQLS.append(",('page_testbattery','title_remove','','en','Delete Battery','',NULL)");
        SQLS.append(",('page_testbattery','title_remove','','fr','Supprimer la Batterie','',NULL)");
        SQLS.append(",('page_testcampaign','addtestcampaign_field','','en','Add Campaign','',NULL)");
        SQLS.append(",('page_testcampaign','addtestcampaign_field','','fr','Ajouter la Campagne','',NULL)");
        SQLS.append(",('page_testcampaign','add_btn','','en','Add','',NULL)");
        SQLS.append(",('page_testcampaign','add_btn','','fr','Ajouter','',NULL)");
        SQLS.append(",('page_testcampaign','allTestcampaigns','','en','Test Campaigns','',NULL)");
        SQLS.append(",('page_testcampaign','allTestcampaigns','','fr','Campagnes de Test','',NULL)");
        SQLS.append(",('page_testcampaign','battery_tab','','en','Battery','',NULL)");
        SQLS.append(",('page_testcampaign','battery_tab','','fr','Batterie','',NULL)");
        SQLS.append(",('page_testcampaign','button_col','','en','Actions','',NULL)");
        SQLS.append(",('page_testcampaign','button_col','','fr','Actions','',NULL)");
        SQLS.append(",('page_testcampaign','button_create','','en','Create Campaign','',NULL)");
        SQLS.append(",('page_testcampaign','button_create','','fr','Créer une Campagne','',NULL)");
        SQLS.append(",('page_testcampaign','button_edit','','en','Edit Campaign','',NULL)");
        SQLS.append(",('page_testcampaign','button_edit','','fr','Editer la Campagne','',NULL)");
        SQLS.append(",('page_testcampaign','button_remove','','en','Delete Campaign','',NULL)");
        SQLS.append(",('page_testcampaign','button_remove','','fr','Supprimer la Campagne','',NULL)");
        SQLS.append(",('page_testcampaign','button_view','','en','View Campaign','',NULL)");
        SQLS.append(",('page_testcampaign','button_view','','fr','Voir la Campagne','',NULL)");
        SQLS.append(",('page_testcampaign','campaign_field','','en','Campaign','',NULL)");
        SQLS.append(",('page_testcampaign','campaign_field','','fr','Campagne','',NULL)");
        SQLS.append(",('page_testcampaign','close_btn','','en','Close','',NULL)");
        SQLS.append(",('page_testcampaign','close_btn','','fr','Fermer','',NULL)");
        SQLS.append(",('page_testcampaign','description_col','','en','Description','',NULL)");
        SQLS.append(",('page_testcampaign','description_col','','fr','Description','',NULL)");
        SQLS.append(",('page_testcampaign','description_field','','en','Description','',NULL)");
        SQLS.append(",('page_testcampaign','description_field','','fr','Description','',NULL)");
        SQLS.append(",('page_testcampaign','description_tab','','en','Description','',NULL)");
        SQLS.append(",('page_testcampaign','description_tab','','fr','Description','',NULL)");
        SQLS.append(",('page_testcampaign','edittestcampaign_field','','en','Edit Campaign','',NULL)");
        SQLS.append(",('page_testcampaign','edittestcampaign_field','','fr','Modifier la Campagne','',NULL)");
        SQLS.append(",('page_testcampaign','message_remove','','en','Are you sure?','',NULL)");
        SQLS.append(",('page_testcampaign','message_remove','','fr','Êtes-vous sûrs?','',NULL)");
        SQLS.append(",('page_testcampaign','parameter_col','','en','Parameter','',NULL)");
        SQLS.append(",('page_testcampaign','parameter_col','','fr','Paramètre','',NULL)");
        SQLS.append(",('page_testcampaign','parameter_tab','','en','Parameter','',NULL)");
        SQLS.append(",('page_testcampaign','parameter_tab','','fr','Paramètre','',NULL)");
        SQLS.append(",('page_testcampaign','save_btn','','en','Save','',NULL)");
        SQLS.append(",('page_testcampaign','save_btn','','fr','Sauvegarder','',NULL)");
        SQLS.append(",('page_testcampaign','table_testcampaign','','en','Test Campaigns',NULL,NULL)");
        SQLS.append(",('page_testcampaign','table_testcampaign','','fr','Campagnes de Test',NULL,NULL)");
        SQLS.append(",('page_testcampaign','testbattery_col','','en','Test Battery','',NULL)");
        SQLS.append(",('page_testcampaign','testbattery_col','','fr','Batterie de test','',NULL)");
        SQLS.append(",('page_testcampaign','testcampaign_col','','en','Test Campaign','',NULL)");
        SQLS.append(",('page_testcampaign','testcampaign_col','','fr','Campagne de test','',NULL)");
        SQLS.append(",('page_testcampaign','testcase_col','','en','Test Case','',NULL)");
        SQLS.append(",('page_testcampaign','testcase_col','','fr','Cas de Test','',NULL)");
        SQLS.append(",('page_testcampaign','test_col','','en','Test','',NULL)");
        SQLS.append(",('page_testcampaign','test_col','','fr','Test','',NULL)");
        SQLS.append(",('page_testcampaign','title_remove','','en','Delete Campaign','',NULL)");
        SQLS.append(",('page_testcampaign','title_remove','','fr','Supprimer la Campagne','',NULL)");
        SQLS.append(",('page_testcampaign','value_col','','en','Value','',NULL)");
        SQLS.append(",('page_testcampaign','value_col','','fr','Valeur','',NULL)");
        SQLS.append(",('page_testcampaign','viewtestcampaign_field','','en','Campaign','',NULL)");
        SQLS.append(",('page_testcampaign','viewtestcampaign_field','','fr','Campagne','',NULL)");
        SQLS.append(",('page_testcase','BugIDLink','','en','Link','',NULL)");
        SQLS.append(",('page_testcase','BugIDLink','','fr','Lien',NULL,NULL)");
        SQLS.append(",('page_testcase','delete','','en','Dlt','Select this checkbox and then save changes in order to delete the row.',NULL)");
        SQLS.append(",('page_testcase','delete','','fr','Sup','',NULL)");
        SQLS.append(",('page_testcase','dpd_choose_step','','en','-- Choose Step  --','',NULL)");
        SQLS.append(",('page_testcase','dpd_choose_step','','fr','-- Choisissez une Etape --',NULL,NULL)");
        SQLS.append(",('page_testcase','dpd_choose_test','','en','-- Choose Test --','',NULL)");
        SQLS.append(",('page_testcase','dpd_choose_test','','fr','-- Choisissez une Test --',NULL,NULL)");
        SQLS.append(",('page_testcase','dpd_choose_testcase','','en','-- Choose Test Case --','',NULL)");
        SQLS.append(",('page_testcase','dpd_choose_testcase','','fr','-- Choisissez un cas de test --',NULL,NULL)");
        SQLS.append(",('page_testcase','laststatus','','en','Last Execution Status','',NULL)");
        SQLS.append(",('page_testcase','laststatus','','fr','Dernier statut d\\'éxecution',NULL,NULL)");
        SQLS.append(",('page_testcase','lbl_copied_from','','en','Copied from:','',NULL)");
        SQLS.append(",('page_testcase','lbl_copied_from','','fr','Copié depuis:',NULL,NULL)");
        SQLS.append(",('page_testcase','link_edit_step','','en','Edit Used Step','',NULL)");
        SQLS.append(",('page_testcase','link_edit_step','','fr','Editer l\\'étape importée',NULL,NULL)");
        SQLS.append(",('page_testcase','message_delete','','en','Do you want to delete Test Case <b>\\'%ENTRY%\\'</b> ?','',NULL)");
        SQLS.append(",('page_testcase','message_delete','','fr','Confirmez vous la suppression du Cas de Test <b>\\'%ENTRY%\\'</b> ?','',NULL)");
        SQLS.append(",('page_testcase','tooltip_addAction','','en','Add Action','',NULL)");
        SQLS.append(",('page_testcase','tooltip_addAction','','fr','Ajouter une Action',NULL,NULL)");
        SQLS.append(",('page_testcase','tooltip_addControl','','en','Add Control','',NULL)");
        SQLS.append(",('page_testcase','tooltip_addControl','','fr','Ajouter un contrôle',NULL,NULL)");
        SQLS.append(",('page_testcase','tooltip_clicktocreate','','en','Property %P% is missing! Click to create a property!','',NULL)");
        SQLS.append(",('page_testcase','tooltip_clicktocreate','','fr','Propriété %P% est manquante. Cliquer pour créer cette propriété',NULL,NULL)");
        SQLS.append(",('page_testcase','tooltip_clicktooverride','','en','Property %P% is defined in the test: %T% - %TC% [step: %S%]. Click to override property!','',NULL)");
        SQLS.append(",('page_testcase','tooltip_clicktooverride','','fr','Propriété %P% est définie dans le Test: %T% - %TC% [étape: %S%]. Cliquer pour réécrire cette propriété!',NULL,NULL)");
        SQLS.append(",('page_testcase','tooltip_infooverriden','','en','Property %P% was overridden in the current Test Case. Original test case: %T% - %TC% [step: %S%]','',NULL)");
        SQLS.append(",('page_testcase','tooltip_infooverriden','','fr','La propriété %P% a été réécrite dans ce cas de test. Cas de test original: %T% - %TC% [étape: %S%]',NULL,NULL)");
        SQLS.append(",('page_testcase','tooltip_is_useStep','','en','This step can not be used as library, because it uses another step!','',NULL)");
        SQLS.append(",('page_testcase','tooltip_is_useStep','','fr','Cette étape ne peut être utilisée en tant que librairie, parce qu\\'elle est utilisée par une autre étape',NULL,NULL)");
        SQLS.append(",('page_testcase','tooltip_select_entry','','en','Select an entry from library','',NULL)");
        SQLS.append(",('page_testcase','tooltip_select_entry','','fr','Selectionner une entrée depuis la librairie',NULL,NULL)");
        SQLS.append(",('page_testcase','tooltip_step_used','','en','This step is being used by another step(s)!','',NULL)");
        SQLS.append(",('page_testcase','tooltip_step_used','','fr','Cette étape est utilisée par une étape',NULL,NULL)");
        SQLS.append(",('page_testcase','txt_property_not_defined','','en','** Property not defined **','',NULL)");
        SQLS.append(",('page_testcase','txt_property_not_defined','','fr','** Propriété non définie **',NULL,NULL)");
        SQLS.append(",('page_testcase','undefined_error_message','','en','There are undefined properties! Please check them before proceed.','',NULL)");
        SQLS.append(",('page_testcase','undefined_error_message','','fr','Il y a des propriétés indéfinies, veuillez les vérifier avant de procéder',NULL,NULL)");
        SQLS.append(",('page_testcaseexecution','table_executionlist','','en','Executions List',NULL,NULL)");
        SQLS.append(",('page_testcaseexecution','table_executionlist','','fr','Liste des executions',NULL,NULL)");
        SQLS.append(",('page_testcaseexecution','title','','en','Test Case Execution','',NULL)");
        SQLS.append(",('page_testcaseexecution','title','','fr','Execution des Cas de Test','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','allExecution','','en','Executions in queue','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','allExecution','','fr','File d\\'exécutions','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','browserVersion_col','','en','Browser version','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','browserVersion_col','','fr','Version du navigateur','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','browser_col','','en','Browser','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','browser_col','','fr','Navigateur','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','button_filterExecuting','','en','Filter Executing',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','button_filterExecuting','','fr','Filtrer En Execution',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','button_filterPending','','en','Filter Pending',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','button_filterPending','','fr','Filtrer En Attente',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','comment_col','','en','Comment','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','comment_col','','fr','Commentaire','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','constrain','','en','Constrain',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','constrain','','fr','Contrainte',NULL,NULL)");
        ...
        SQLS.append(",('page_testcaseexecutionqueue','id_col','','fr','ID','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','manualContextRoot_col','','en','Manual execution context root','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','manualContextRoot_col','','fr','Contexte racine de l\\'execution manuelle','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','manualEnvData_col','','en','Manual execution environment data','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','manualEnvData_col','','fr','Données d\\'environnement de l\\'execution manuelle','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','manualExecution_col','','en','Manual execution','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','manualExecution_col','','fr','Execution manuelle','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','manualHost_col','','en','Manual execution host','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','manualHost_col','','fr','Domaine de l\\'execution manuelle','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','manualLoginRelativeURL_col','','en','Manual execution login relative URL','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','manualLoginRelativeURL_col','','fr','URL relative de connexion pour l\\'execution manuelle','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','manualURL_col','','en','Manual execution URL','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','manualURL_col','','fr','URL de l\\'execution manuelle','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','nbInQueue','','en','Execution nb in the Queue',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','nbInQueue','','fr','Nb d\\'éxécutions en queue',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','nbPoolSize','','en','Max Pool Size',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','nbPoolSize','','fr','Taille max du Pool',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','nbRunning','','en','Execution nb Running',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','nbRunning','','fr','Nb d\\'éxécutions en cours',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','oversaturation','','en','Execution nb on saturated queue',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','oversaturation','','fr','Nb d\\'éxécutions dans pool saturés',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','pageSource_col','','en','Page source','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','pageSource_col','','fr','Code source','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','platform_col','','en','Platform','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','platform_col','','fr','Plateforme','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','processed_col','','en','Proceeded','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','processed_col','','fr','Traité','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','requestDate_col','','en','Last State Date','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','requestDate_col','','fr','Date du dernier Etat','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','retries_col','','en','Retries','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','retries_col','','fr','Tentatives','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','robotIP_col','','en','Robot host','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','robotIP_col','','fr','Domaine du Robot','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','robotPort_col','','en','Robot port','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','robotPort_col','','fr','Port du Robot','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','robot_col','','en','Robot','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','robot_col','','fr','Robot','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','saturation','','en','Saturation %',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','saturation','','fr','% de saturation',NULL,NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','screenshot_col','','en','Screenshots','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','screenshot_col','','fr','Captures d\\'écrans','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','seleniumLog_col','','en','Selenium logs','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','seleniumLog_col','','fr','Journalisation Selenium','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','state_col','','en','State','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','state_col','','fr','Etat','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','tag_col','','en','Tag','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','tag_col','','fr','Tag','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','testcase_col','','en','Test Case','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','testcase_col','','fr','Cas de Test','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','test_col','','en','Test','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','test_col','','fr','Test','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','timeout_col','','en','Timeout','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','timeout_col','','fr','Dépassement de temps','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','tooltip_dupentry','','en','Duplicate Queue entry','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','tooltip_dupentry','','fr','Dupliquer l\\'éxécution en queue','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','tooltip_editentry','','en','Edit Queue entry','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','tooltip_editentry','','fr','Editer l\\'exécution en queue','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','tooltip_viewentry','','en','View Queue entry','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','tooltip_viewentry','','fr','Voir l\\'exécution en queue','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','verbose_col','','en','Verbose','',NULL)");
        SQLS.append(",('page_testcaseexecutionqueue','verbose_col','','fr','Verbeux','',NULL)");
        SQLS.append(",('page_testcaselist','activationCriteria','','en','Activation Criteria','',NULL)");
        SQLS.append(",('page_testcaselist','activationCriteria','','fr','Critères d\\'activation','',NULL)");
        SQLS.append(",('page_testcaselist','btn_create','','en','Create Test Case',NULL,NULL)");
        SQLS.append(",('page_testcaselist','btn_create','','fr','Créer un Cas de Test',NULL,NULL)");
        SQLS.append(",('page_testcaselist','btn_delete','','en','Delete Test Case','',NULL)");
        SQLS.append(",('page_testcaselist','btn_delete','','fr','Supprimer le Cas de Test','',NULL)");
        SQLS.append(",('page_testcaselist','btn_duplicate','','en','Duplicate Test Case','',NULL)");
        SQLS.append(",('page_testcaselist','btn_duplicate','','fr','Dupliquer le Cas de Test','',NULL)");
        SQLS.append(",('page_testcaselist','btn_edit','','en','Edit Test Case Header','',NULL)");
        SQLS.append(",('page_testcaselist','btn_edit','','fr','Modifer l\\'Entete du Cas de Test','',NULL)");
        SQLS.append(",('page_testcaselist','btn_editLabel','','en','Edit Test Case labels','',NULL)");
        SQLS.append(",('page_testcaselist','btn_editLabel','','fr','Modifier les étiquettes du Cas de Test','',NULL)");
        SQLS.append(",('page_testcaselist','btn_editScript','','en','Go to Test Case Script Page','',NULL)");
        SQLS.append(",('page_testcaselist','btn_editScript','','fr','Aller à la page du Script du Cas de Test','',NULL)");
        SQLS.append(",('page_testcaselist','btn_runTest','','en','Run Test Case','',NULL)");
        SQLS.append(",('page_testcaselist','btn_runTest','','fr','Exécuter le Cas de Test','',NULL)");
        SQLS.append(",('page_testcaselist','btn_view','','en','View Test Case','',NULL)");
        SQLS.append(",('page_testcaselist','btn_view','','fr','Voir Cas de Test','',NULL)");
        SQLS.append(",('page_testcaselist','filters','','en','Filters','Test filter',NULL)");
        SQLS.append(",('page_testcaselist','filters','','fr','Filtres','Filtre des tests',NULL)");
        SQLS.append(",('page_testcaselist','link','','en','Bug Link','',NULL)");
        SQLS.append(",('page_testcaselist','link','','fr','Lien vers le Bug','',NULL)");
        SQLS.append(",('page_testcaselist','massAction','','en','Massively update the selected test cases','',NULL)");
        SQLS.append(",('page_testcaselist','massAction','','fr','Mise à jour en masse les Cas de Test selectionnés','',NULL)");
        SQLS.append(",('page_testcaselist','tabLabel','','en','Label Management',NULL,NULL)");
        SQLS.append(",('page_testcaselist','tabLabel','','fr','Gestion des Labels',NULL,NULL)");
        SQLS.append(",('page_testcaselist','tabUpdate','','en','Update',NULL,NULL)");
        SQLS.append(",('page_testcaselist','tabUpdate','','fr','Mise à jour',NULL,NULL)");
        SQLS.append(",('page_testcaselist','testCaseInfo','','en','Test Case Info','',NULL)");
        SQLS.append(",('page_testcaselist','testCaseInfo','','fr','Test Case Info','',NULL)");
        SQLS.append(",('page_testcaselist','testcaselist','','en','Test Case List','List of all the test case of the selected test',NULL)");
        SQLS.append(",('page_testcaselist','testcaselist','','fr','Liste des Cas de Test','Liste de tout les cas de test du test selectionné',NULL)");
        SQLS.append(",('page_testcaselist','testCaseParameter','','en','Test Case Parameter','',NULL)");
        SQLS.append(",('page_testcaselist','testCaseParameter','','fr','Parametres du Cas de Test','',NULL)");
        SQLS.append(",('page_testcaselist','testInfo','','en','Test Info','',NULL)");
        SQLS.append(",('page_testcaselist','testInfo','','fr','Test Info','',NULL)");
        SQLS.append(",('page_testcasescript','action_field','','en','Action : ','',NULL)");
        SQLS.append(",('page_testcasescript','action_field','','fr','Action : ','',NULL)");
        SQLS.append(",('page_testcasescript','add_action','','en','Add Action','',NULL)");
        SQLS.append(",('page_testcasescript','add_action','','fr','Ajouter une Action','',NULL)");
        SQLS.append(",('page_testcasescript','add_step','','en','Add step','',NULL)");
        SQLS.append(",('page_testcasescript','add_step','','fr','Ajouter une Etape','',NULL)");
        SQLS.append(",('page_testcasescript','cant_detach_library','','en','You can\\'t detach this library because it is used in these steps : ','',NULL)");
        SQLS.append(",('page_testcasescript','cant_detach_library','','fr','Vous ne pouvez pas détacher cette librairie car elle est utilisée dans ces étapes : ','',NULL)");
        SQLS.append(",('page_testcasescript','condition_operation_field','','en','Condition Operation : ','',NULL)");
        SQLS.append(",('page_testcasescript','condition_operation_field','','fr','Condition d execution : ','',NULL)");
        SQLS.append(",('page_testcasescript','condition_parameter_field','','en','Condition Parameter : ','',NULL)");
        SQLS.append(",('page_testcasescript','condition_parameter_field','','fr','Paramètre de la condition : ','',NULL)");
        SQLS.append(",('page_testcasescript','control_field','','en','Control : ','',NULL)");
        ...
        SQLS.append(",('page_testcasescript','describe_control','','fr','Décrivez ce control','',NULL)");
        ...
        SQLS.append(",('page_testcasescript','feed_propertydescription','','fr','Remplissez la description','',NULL)");
        SQLS.append(",('page_testcasescript','feed_propertyname','','en','Feed Property name','',NULL)");
        ...
        SQLS.append(",('page_testcasescript','index','','fr','Index : ','',NULL)");
        SQLS.append(",('page_testcasescript','length','','en','Length','',NULL)");
        SQLS.append(",('page_testcasescript','length','','fr','Taille','',NULL)");
        SQLS.append(",('page_testcasescript','length_field','','en','Length : ','',NULL)");
        SQLS.append(",('page_testcasescript','length_field','','fr','Taille : ','',NULL)");
        SQLS.append(",('page_testcasescript','manage_prop','','en','Manage Properties','',NULL)");
        SQLS.append(",('page_testcasescript','manage_prop','','fr','Gestion des Propriétés','',NULL)");
        SQLS.append(",('page_testcasescript','nature_field','','en','Nature : ','',NULL)");
        SQLS.append(",('page_testcasescript','nature_field','','fr','Nature : ','',NULL)");
        SQLS.append(",('page_testcasescript','not_application_object','','en','It is not an Application Object','',NULL)");
        SQLS.append(",('page_testcasescript','not_application_object','','fr','Ce n\\'est pas un object de l\\'application','',NULL)");
        SQLS.append(",('page_testcasescript','not_property','','en','It is not a property','',NULL)");
        SQLS.append(",('page_testcasescript','not_property','','fr','Ce n\\'est pas une propriété','',NULL)");
        SQLS.append(",('page_testcasescript','property_field','','en','Property : ','',NULL)");
        ...
        SQLS.append(",('page_testcasescript','retrynb','','fr','Nombre d\\'essais :','',NULL)");
        SQLS.append(",('page_testcasescript','retryperiod','','en','Retry Period :','',NULL)");
        SQLS.append(",('page_testcasescript','retryperiod','','fr','Periode d\\'essai :','',NULL)");
        SQLS.append(",('page_testcasescript','rMessage','','en','Result Message :','',NULL)");
        SQLS.append(",('page_testcasescript','rMessage','','fr','Message de Retour :','',NULL)");
        SQLS.append(",('page_testcasescript','rowlimit_field','','en','Row limit : ','',NULL)");
        ...
        SQLS.append(",('page_testcasescript','select_testcase','','fr','Sélectionner un TestCase','',NULL)");
        SQLS.append(",('page_testcasescript','steps_title','','en','Steps','',NULL)");
        SQLS.append(",('page_testcasescript','steps_title','','fr','Etapes','',NULL)");
        SQLS.append(",('page_testcasescript','step_condition_operation','','en','Step Condition Operation','',NULL)");
        SQLS.append(",('page_testcasescript','step_condition_operation','','fr','Condition d\\'exécution de l\\'étape','',NULL)");
        SQLS.append(",('page_testcasescript','step_condition_value1','','en','Step Condition Parameter','',NULL)");
        SQLS.append(",('page_testcasescript','step_condition_value1','','fr','Paramètre de condition','',NULL)");
        SQLS.append(",('page_testcasescript','testcasescript_title','','en','Test Case Script','',NULL)");
        SQLS.append(",('page_testcasescript','testcasescript_title','','fr','Script du Test Case','',NULL)");
        SQLS.append(",('page_testcasescript','type_field','','en','Type : ','',NULL)");
        SQLS.append(",('page_testcasescript','type_field','','fr','Type : ','',NULL)");
        SQLS.append(",('page_testcasescript','unlink_useStep','','en','Unlink Used step','',NULL)");
        SQLS.append(",('page_testcasescript','unlink_useStep','','fr','Délier l\\'étape de sa librairie','',NULL)");
        SQLS.append(",('page_testcasescript','unlink_useStep_warning','','en','Are you sure you want to unlink this used step ? You can\\'t undo this.','',NULL)");
        SQLS.append(",('page_testcasescript','unlink_useStep_warning','','fr','Etes vous sur de vouloir délier cette étape de sa librairie ? Cette action n\\'est pas annulable.','',NULL)");
        SQLS.append(",('page_testcasescript','value1init_field','','en','Value 1 Initial :','',NULL)");
        SQLS.append(",('page_testcasescript','value1init_field','','fr','Valeur 1 Initiale :','',NULL)");
        SQLS.append(",('page_testcasescript','value1_field','','en','Value1 : ','',NULL)");
        SQLS.append(",('page_testcasescript','value1_field','','fr','Value1 : ','',NULL)");
        SQLS.append(",('page_testcasescript','value2init_field','','en','Value 2 Initial :','',NULL)");
        SQLS.append(",('page_testcasescript','value2init_field','','fr','Valeur 2 Initiale :','',NULL)");
        SQLS.append(",('page_testcasescript','value2_field','','en','Value2 : ','',NULL)");
        SQLS.append(",('page_testcasescript','value2_field','','fr','Value2 : ','',NULL)");
        ...
        SQLS.append(",('page_testcasescript','warning_one_empty_prop','','fr','Il y a au moins une propriétée sans pays. Si vous sauvegardez elle sera supprimée. Voulez-vous vraiment sauvegarder ?','',NULL)");
        SQLS.append(",('page_testcasesearch','text','','en','Text','Insert here the text that will search against the following Fields of every <code class=\\'doc-crbvvoca\\'>test case</code> :<br>- Short Description,<br>- Detailed description / Value Expected,<br>- HowTo<br>- Comment<br><br>NB : Search is case insensitive.',NULL)");
        SQLS.append(",('page_testcasesearch','text','','fr','Texte',NULL,NULL)");
        SQLS.append(",('page_testcase_m_addPicture','error_message_empty','','en','The URL value is empty!','',NULL)");
        SQLS.append(",('page_testcase_m_addPicture','error_message_empty','','fr','La valeur de l\\'URL est vide',NULL,NULL)");
        SQLS.append(",('page_testcase_m_addPicture','lbl_feedurl','','en','Feed URL','',NULL)");
        SQLS.append(",('page_testcase_m_addPicture','lbl_feedurl','','fr','Fournir URL',NULL,NULL)");
        SQLS.append(",('page_testcase_m_addPicture','title','','en','Add URL for picture','',NULL)");
        SQLS.append(",('page_testcase_m_showPicture','btn_remove','','en','Delete','',NULL)");
        SQLS.append(",('page_testcase_m_showPicture','btn_remove','','fr','Retirer',NULL,NULL)");
        SQLS.append(",('page_testcase_m_showPicture','title','','en','Selected Picture','',NULL)");
        SQLS.append(",('page_testdatalib','btn_create','','en','Create New Data Library','',NULL)");
        SQLS.append(",('page_testdatalib','btn_create','','fr','Créer une nouvelle entrée',NULL,NULL)");
        SQLS.append(",('page_testdatalib','btn_import','','en','Import from XML file','',NULL)");
        SQLS.append(",('page_testdatalib','btn_import','','fr','Importer d\\'un fichier XML',NULL,NULL)");
        SQLS.append(",('page_testdatalib','duplicated_message','','en','Please check the subdata entries. There are entries with duplicated names, a total of: ','',NULL)");
        SQLS.append(",('page_testdatalib','duplicated_message','','fr','Veuillez vérifier les sous données, il y a au moins un doublon de nom',NULL,NULL)");
        SQLS.append(",('page_testdatalib','empty_name_message','','en','Please specify the name of the Data Library !','',NULL)");
        SQLS.append(",('page_testdatalib','empty_name_message','','fr','Veuillez spécifier le nom de l\\'entrée',NULL,NULL)");
        SQLS.append(",('page_testdatalib','empty_subdata_message','','en','Please check the subdata entries. There are entries without sub-data name, a total of: ','',NULL)");
        SQLS.append(",('page_testdatalib','empty_subdata_message','','fr','Veuillez vérifier s\\'il vous plait les sous données, il manque au moins un nom d\\'entrée',NULL,NULL)");
        SQLS.append(",('page_testdatalib','message_delete','','en','Do you want to delete Test Data Library <b>\\'%ENTRY%\\'</b> <br>of system <b>\\'%SYSTEM%\\'</b>, country <b>\\'%COUNTRY%\\'</b> and environment <b>\\'%ENVIRONMENT%\\'</b> (ID : %ID%) ?','',NULL)");
        SQLS.append(",('page_testdatalib','message_delete','','fr','Confirmez-vous la suppression de la donnée de test <b>\\'%ENTRY%\\'</b> <br>du système <b>\\'%SYSTEM%\\'</b>, pays <b>\\'%COUNTRY%\\'</b> et environnement <b>\\'%ENVIRONMENT%\\'</b> (ID : %ID%) ?','',NULL)");
        SQLS.append(",('page_testdatalib','m_tab1_text','','en','Definition','',NULL)");
        SQLS.append(",('page_testdatalib','m_tab1_text','','fr','Defintion','',NULL)");
        SQLS.append(",('page_testdatalib','m_tab2_text','','en','SubData','',NULL)");
        SQLS.append(",('page_testdatalib','m_tab2_text','','fr','SubData','',NULL)");
        SQLS.append(",('page_testdatalib','m_tab3_text','','en','Tracability','',NULL)");
        SQLS.append(",('page_testdatalib','m_tab3_text','','fr','Traçabité','',NULL)");
        SQLS.append(",('page_testdatalib','page_title','','en','Test Data Library','',NULL)");
        SQLS.append(",('page_testdatalib','page_title','','fr','Librairie de données de tests',NULL,NULL)");
        SQLS.append(",('page_testdatalib','table_testdatalib','','en','Test Data List',NULL,NULL)");
        SQLS.append(",('page_testdatalib','table_testdatalib','','fr','Liste de Données',NULL,NULL)");
        ...
        SQLS.append(",('page_testdatalib','title','','fr','Librairie de données',NULL,'_librairie_de_données')");
        SQLS.append(",('page_testdatalib','title_csv_configurations','','en','CSV configurations','',NULL)");
        SQLS.append(",('page_testdatalib','title_csv_configurations','','fr','Configuration CSV','',NULL)");
        SQLS.append(",('page_testdatalib','title_service_configurations','','en','SERVICE configurations','',NULL)");
        SQLS.append(",('page_testdatalib','title_service_configurations','','fr','SERVICE configurations',NULL,NULL)");
        SQLS.append(",('page_testdatalib','title_soap_configurations','','fr','Configurations SOAP',NULL,NULL)");
        SQLS.append(",('page_testdatalib','title_sql_configurations','','en','SQL configurations','',NULL)");
        SQLS.append(",('page_testdatalib','title_sql_configurations','','fr','Configurations SQL',NULL,NULL)");
        SQLS.append(",('page_testdatalib','tooltip_delete','','en','Delete Data Library','',NULL)");
        SQLS.append(",('page_testdatalib','tooltip_delete','','fr','Supprimer cette entrée',NULL,NULL)");
        SQLS.append(",('page_testdatalib','tooltip_duplicateEntry','','en','Duplicate this Data Library','',NULL)");
        SQLS.append(",('page_testdatalib','tooltip_duplicateEntry','','fr','Dupliquer cette entrée',NULL,NULL)");
        SQLS.append(",('page_testdatalib','tooltip_editentry','','en','Edit Data Library','',NULL)");
        SQLS.append(",('page_testdatalib','tooltip_editentry','','fr','Editer l\\'entrée',NULL,NULL)");
        SQLS.append(",('page_testdatalib','tooltip_editsubdata','','en','Edit sub-data entries','',NULL)");
        SQLS.append(",('page_testdatalib','tooltip_editsubdata','','fr','Editer les entrées des sous-données',NULL,NULL)");
        SQLS.append(",('page_testdatalib','tooltip_gettestcases','','en','Get list of test cases that use this entry','',NULL)");
        SQLS.append(",('page_testdatalib','tooltip_gettestcases','','fr','Voir la liste des cas de tests qui utilisent cette entrée',NULL,NULL)");
        SQLS.append(",('page_testdatalib','tooltip_viewsubdata','','en','View sub-data entries','',NULL)");
        SQLS.append(",('page_testdatalib','tooltip_viewsubdata','','fr','Voir les entrées des sous données',NULL,NULL)");
        SQLS.append(",('page_testdatalib_delete','title','','en','Delete Test Data Library Entry','',NULL)");
        SQLS.append(",('page_testdatalib_m_createlib','title','','en','Create New Test Data Library Entry','',NULL)");
        SQLS.append(",('page_testdatalib_m_duplicatelib','title','','en','Duplicate Test Data Library','',NULL)");
        SQLS.append(",('page_testdatalib_m_gettestcases','group_title','','en','Test cases affected by this entry','',NULL)");
        SQLS.append(",('page_testdatalib_m_gettestcases','group_title','','fr','Cas de test affectés par cette entrée',NULL,NULL)");
        SQLS.append(",('page_testdatalib_m_gettestcases','nrProperties','','en','#properties:','',NULL)");
        SQLS.append(",('page_testdatalib_m_gettestcases','nrProperties','','fr','#propriétés:',NULL,NULL)");
        SQLS.append(",('page_testdatalib_m_gettestcases','nrTestCases','','en','#test cases:','',NULL)");
        SQLS.append(",('page_testdatalib_m_gettestcases','nrTestCases','','fr','#cas de tests:',NULL,NULL)");
        SQLS.append(",('page_testdatalib_m_gettestcases','nrTests','','en','#tests: ','',NULL)");
        SQLS.append(",('page_testdatalib_m_gettestcases','nrTests','','fr','#tests: ',NULL,NULL)");
        SQLS.append(",('page_testdatalib_m_gettestcases','title','','en','List of test cases affected by this entry','',NULL)");
        SQLS.append(",('page_testdatalib_m_listtestdatalibdata','title','','en','List of sub-data entries','',NULL)");
        ...
        SQLS.append(",('page_testdatalib_m_managetestdatalibdata','link_add_new','','en','Add new sub-data','',NULL)");
        SQLS.append(",('page_testdatalib_m_managetestdatalibdata','link_add_new','','fr','Ajouter une nouvelle sous-donnée',NULL,NULL)");
        SQLS.append(",('page_testdatalib_m_managetestdatalibdata','link_add_new_title','','en','Add a new row in the list of sub-data entries','',NULL)");
        SQLS.append(",('page_testdatalib_m_managetestdatalibdata','link_add_new_title','','fr','Ajouter une nouvelle ligne dans la liste des sous-données',NULL,NULL)");
        SQLS.append(",('page_testdatalib_m_managetestdatalibdata','title','','en','Manage list of sub-data entries','',NULL)");
        SQLS.append(",('page_testdatalib_m_managetestdatalibdata','tooltip_defaultsubdata','','en','This is the default sub-data entry. It cannot be deleted nor its name can be modified.','',NULL)");
        SQLS.append(",('page_testdatalib_m_managetestdatalibdata','tooltip_defaultsubdata','','fr','C\\'est l\\'entrée de la sous-donnée par defaut, ne peut être modifiée ni supprimée',NULL,NULL)");
        SQLS.append(",('page_testdatalib_m_updatelib','title','','en','Edit Test Data Library Entry','',NULL)");
        SQLS.append(",('page_user','adduser_field','','en','Add User','',NULL)");
        SQLS.append(",('page_user','adduser_field','','fr','Ajouter un utilisateur','',NULL)");
        SQLS.append(",('page_user','add_btn','','en','Add','',NULL)");
        SQLS.append(",('page_user','add_btn','','fr','Ajouter','',NULL)");
        SQLS.append(",('page_user','allUsers','','en','Users','',NULL)");
        SQLS.append(",('page_user','allUsers','','fr','Utilisateurs','',NULL)");
        SQLS.append(",('page_user','button_col','','en','Actions','',NULL)");
        SQLS.append(",('page_user','button_col','','fr','Actions','',NULL)");
        SQLS.append(",('page_user','button_create','','en','Create User','',NULL)");
        SQLS.append(",('page_user','button_create','','fr','Créer un Utilisateur','',NULL)");
        SQLS.append(",('page_user','button_edit','','en','Edit User','',NULL)");
        SQLS.append(",('page_user','button_edit','','fr','Editer l\\'Utilisateur','',NULL)");
        SQLS.append(",('page_user','button_remove','','en','Delete User','',NULL)");
        SQLS.append(",('page_user','button_remove','','fr','Supprimer l\\'Utilisateur','',NULL)");
        SQLS.append(",('page_user','close_btn','','en','Close','',NULL)");
        SQLS.append(",('page_user','close_btn','','fr','Fermer','',NULL)");
        SQLS.append(",('page_user','defaultsystem_col','','en','Default System','',NULL)");
        SQLS.append(",('page_user','defaultsystem_col','','fr','Système par défaut','',NULL)");
        SQLS.append(",('page_user','defaultsystem_field','','en','Default System','',NULL)");
        SQLS.append(",('page_user','defaultsystem_field','','fr','Système par défaut','',NULL)");
        SQLS.append(",('page_user','edituser_field','','en','Edit User','',NULL)");
        SQLS.append(",('page_user','edituser_field','','fr','Modifier l\\'Utilisateur','',NULL)");
        SQLS.append(",('page_user','email_col','','en','Email','',NULL)");
        SQLS.append(",('page_user','email_col','','fr','Email','',NULL)");
        SQLS.append(",('page_user','email_field','','en','Email','',NULL)");
        SQLS.append(",('page_user','email_field','','fr','Email','',NULL)");
        SQLS.append(",('page_user','groups_col','','en','Groups','',NULL)");
        SQLS.append(",('page_user','groups_col','','fr','Groupes','',NULL)");
        SQLS.append(",('page_user','groups_field','','en','Groups','',NULL)");
        SQLS.append(",('page_user','groups_field','','fr','Groupes','',NULL)");
        SQLS.append(",('page_user','information_tab','','en','Information','',NULL)");
        SQLS.append(",('page_user','information_tab','','fr','Information','',NULL)");
        SQLS.append(",('page_user','login_col','','en','Login','',NULL)");
        SQLS.append(",('page_user','login_col','','fr','Identifiant','',NULL)");
        SQLS.append(",('page_user','login_field','','en','Login','',NULL)");
        SQLS.append(",('page_user','login_field','','fr','Identifiant','',NULL)");
        SQLS.append(",('page_user','message_remove','','en','Are you sure?','',NULL)");
        SQLS.append(",('page_user','message_remove','','fr','Êtes-vous sûrs?','',NULL)");
        SQLS.append(",('page_user','name_col','','en','Name','',NULL)");
        SQLS.append(",('page_user','name_col','','fr','Nom','',NULL)");
        SQLS.append(",('page_user','name_field','','en','Name','',NULL)");
        SQLS.append(",('page_user','name_field','','fr','Nom','',NULL)");
        SQLS.append(",('page_user','request_col','','en','Request','',NULL)");
        SQLS.append(",('page_user','request_col','','fr','Requête','',NULL)");
        SQLS.append(",('page_user','request_field','','en','Request','',NULL)");
        SQLS.append(",('page_user','request_field','','fr','Requête','',NULL)");
        SQLS.append(",('page_user','save_btn','','en','Save','',NULL)");
        SQLS.append(",('page_user','save_btn','','fr','Sauvegarder','',NULL)");
        SQLS.append(",('page_user','systems_col','','en','Systems','',NULL)");
        SQLS.append(",('page_user','systems_col','','fr','Systèmes','',NULL)");
        SQLS.append(",('page_user','systems_field','','en','System','',NULL)");
        SQLS.append(",('page_user','systems_field','','fr','Système','',NULL)");
        SQLS.append(",('page_user','systems_tab','','en','Systems','',NULL)");
        SQLS.append(",('page_user','systems_tab','','fr','Systèmes','',NULL)");
        SQLS.append(",('page_user','table_user','','en','Users',NULL,NULL)");
        SQLS.append(",('page_user','table_user','','fr','Utilisateurs',NULL,NULL)");
        SQLS.append(",('page_user','team_col','','en','Team','',NULL)");
        SQLS.append(",('page_user','team_col','','fr','Equipe','',NULL)");
        SQLS.append(",('page_user','team_field','','en','Team','',NULL)");
        SQLS.append(",('page_user','team_field','','fr','Equipe','',NULL)");
        SQLS.append(",('page_user','title_remove','','en','Delete User','',NULL)");
        SQLS.append(",('page_user','title_remove','','fr','Supprimer l\\'Utilisateur','',NULL)");
        SQLS.append(",('project','active','','en','Active','This is a boolean that define if the project is active or not.',NULL)");
        SQLS.append(",('project','active','','fr','Actif','Booléen qui défini si un projet est actif.',NULL)");
        SQLS.append(",('project','code','','en','Code','This is the code of the project. ',NULL)");
        SQLS.append(",('project','code','','fr','Code','Code du projet.',NULL)");
        SQLS.append(",('project','dateCreation','','en','Created','This is the date when the project has been created.',NULL)");
        SQLS.append(",('project','dateCreation','','fr','Date de Création','Date de création du projet.',NULL)");
        SQLS.append(",('project','description','','en','Description','This is the description of the project',NULL)");
        SQLS.append(",('project','description','','fr','Description','Description du projet',NULL)");
        SQLS.append(",('project','idproject','','en','Project','This is the id of the project that provided the implementation of the <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('project','idproject','','fr','Projet','Identifiant du projet qui est à l\\'origine de la création d\\'un <code class=\\'doc-crbvvoca\\'>cas de test</code>.',NULL)");
        SQLS.append(",('robot','active','','en','Active','Define if the robot is active or not.',NULL)");
        SQLS.append(",('robot','active','','fr','Actif','Defini si le robot est actif ou non.',NULL)");
        SQLS.append(",('robot','browser','','en','Browser','Broswer of the robot.',NULL)");
        SQLS.append(",('robot','browser','','fr','Navigateur','Navitateur du robot.',NULL)");
        SQLS.append(",('robot','capabilityCapability','','en','Capability','Capability name.',NULL)");
        SQLS.append(",('robot','capabilityCapability','','fr','Capabilité','Nom de la capabilité.',NULL)");
        SQLS.append(",('robot','capabilityValue','','en','Value','Capability value.',NULL)");
        SQLS.append(",('robot','capabilityValue','','fr','Valeur','Valeur de la capabilité.',NULL)");
        SQLS.append(",('robot','description','','en','Description','Robot Description.',NULL)");
        SQLS.append(",('robot','description','','fr','Description','Description du robot.',NULL)");
        SQLS.append(",('robot','host','','en','Hostname','IP Adress or host that host the selenium server that will execute the test case.',NULL)");
        SQLS.append(",('robot','host','','fr','Hostname','Address IP ou nom de server qui heberge le robot et qui sera utilisé lors l\\'excution du cas de test.',NULL)");
        SQLS.append(",('robot','platform','','en','Platform','Operating system of the robot.',NULL)");
        SQLS.append(",('robot','platform','','fr','Platforme','System d\\'exploitation du robot.',NULL)");
        SQLS.append(",('robot','port','','en','Port number','Port number of the robot.',NULL)");
        SQLS.append(",('robot','port','','fr','Numero de port','Numero du port à utiliser pour acceder au Root.',NULL)");
        SQLS.append(",('robot','robot','','en','Robot','Name of the Robot. A robot define the server that will execute an automated test case. It can be used when starting an execution without having to feed information such as host, port platform or browser.',NULL)");
        SQLS.append(",('robot','robot','','fr','Robot','Nom du Robot. Le Robot est le serveur en charge de l\\'execution d\\'un test automatisé. Il permet de lancer une execution de test sans avoir à renseigner l\\'IP, le port, le navigateur ou OS à utiliser.',NULL)");
        SQLS.append(",('robot','robotID','','en','Robot ID','Technical identifier of the Robot.',NULL)");
        SQLS.append(",('robot','robotID','','fr','ID du Robot','Identifiant technique invariant du Robot.',NULL)");
        ...
        SQLS.append(",('robot','useragent','','en','User Agent','User Agent of the robot.',NULL)");
        SQLS.append(",('robot','useragent','','fr','User Agent','User Agent du Robot.',NULL)");
        SQLS.append(",('robot','version','','en','Version','Brower Version of the robot.',NULL)");
        SQLS.append(",('robot','version','','fr','Version','Version du navigateur du Robot.',NULL)");
        SQLS.append(",('test','Active','','en','Active','Define if the <code class=\\'doc-crbvvoca\\'>test</code> is active.<br>If <code class=\\'doc-crbvvoca\\'>test</code> is not active, no execution is possible on any of the associated <code class=\\'doc-crbvvoca\\'>test case</code>.','_test')");
        SQLS.append(",('test','Active','','fr','Actif','Booléen qui définit si le <code class=\\'doc-crbvvoca\\'>test</code> est actif.<br>Si le <code class=\\'doc-crbvvoca\\'>test</code> n\\'est pas actif, aucune execution des <code class=\\'doc-crbvvoca\\'>Cas de tests</code> n\\'est possible.','_test')");
        SQLS.append(",('test','Automated','','en','Automated','Define if the test is automated or not.','_test')");
        SQLS.append(",('test','Automated','','fr','Automatisé','Boléen qui définit si le test est automatisé ou non','_test')");
        SQLS.append(",('test','dateCreation','','en','Creation date','The date when the test have been created','_test')");
        SQLS.append(",('test','dateCreation','','fr','Date de création','Date à laquelle le test a été créé','_test')");
        SQLS.append(",('test','Description','','en','Test Description','This is the description of the <code class=\\'doc-crbvvoca\\'>test</code>.','_test')");
        ...
        SQLS.append(",('testcasecountryproperties','Nature','','en','Nature','Nature is the parameter which define the unicity of the property calculation for this testcase in every execution.<br><br>It can take the following values :',NULL)");
        SQLS.append(",('testcasecountryproperties','Nature','','fr','Nature',NULL,NULL)");
        ...
        SQLS.append(",('testcasecountryproperties','Nature','NOTINUSE','fr','Valeur non utilisée actuellement',NULL,NULL)");
        SQLS.append(",('testcasecountryproperties','Nature','RANDOM','en','Random values.','<code class=\\'doc-fixed\\'>RANDOM</code> : When the property return a list of value, RANDOM will take a random value(s) on the list. It could be the same accross 2 different executions.',NULL)");
        SQLS.append(",('testcasecountryproperties','Nature','RANDOM','fr','Valeurs aléatoires',NULL,NULL)");
        ...
        SQLS.append(",('testcasecountryproperties','Nature','RANDOMNEW','fr','Valeur unique aléatoire',NULL,NULL)");
        SQLS.append(",('testcasecountryproperties','Nature','STATIC','en','No unicity rule.','<code class=\\'doc-fixed\\'>STATIC</code> : No rules are defined. The property could be the same for all the executions',NULL)");
        SQLS.append(",('testcasecountryproperties','Nature','STATIC','fr','Aucune règle d\\'unicité',NULL,NULL)");
        ...
        SQLS.append(",('testcasecountryproperties','Property','','fr','Propriété',NULL,NULL)");
        SQLS.append(",('testcasecountryproperties','RetryNb','','en','Retry','Integer that correspond to the number of time the calculation of the property will be done until the property gets a valid result.',NULL)");
        SQLS.append(",('testcasecountryproperties','RetryPeriod','','en','Period','Integer that specify the amount of time (in ms) that Cerberus will wait between 2 retry attempt of the property calculation.',NULL)");
        ...
        SQLS.append(",('testcasecountryproperties','RowLimit','','fr','Limite de lignes ',NULL,NULL)");
        SQLS.append(",('testcasecountryproperties','Type','','en','Type1','This is the type of command which will be used to calculate the property.<br><br>It can take the following values :',NULL)");
        SQLS.append(",('testcasecountryproperties','Type','executeSoapFromLib','en','[DEPRECATED] Get a value from a SOAP Request','TBD.',NULL)");
        ...
        SQLS.append(",('testcasecountryproperties','Type','getDifferencesFromXml','en','Get differences from 2 XML files','TBD.',NULL)");
        ...
        SQLS.append(",('testcaseexecution','Browser','','en','Browser','This is the browser that was used to run the <code class=\\'doc-crbvvoca\\'>test case</code> (only used if that was a GUI application <code class=\\'doc-crbvvoca\\'>test case</code>).',NULL)");
        SQLS.append(",('testcaseexecution','BrowserFullVersion','','en','Browser Version','This is the full version information of the browser that was used to run the <code class=\\'doc-crbvvoca\\'>test case</code> (only used if that was a GUI application <code class=\\'doc-crbvvoca\\'>test case</code>).',NULL)");
        SQLS.append(",('testcaseexecution','BrowserFullVersion','','fr','Version du navigateur',NULL,NULL)");
        SQLS.append(",('testcaseexecution','Build','','en','Sprint','Name of the Build/sprint.',NULL)");
        SQLS.append(",('testcaseexecution','ControlMessage','','en','ControlMessage','This is the message reported by Cerberus on the execution of the <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        ...
        SQLS.append(",('testcaseexecution','crbversion','','en','Cerberus Version','This is the version of the Cerberus Engine that executed the <code class=\\'doc-crbvvoca\\'>test case</code>.<br>This data has been created for tracability purpose as the behavious of Cerberus could varry from one version to another.',NULL)");
        SQLS.append(",('testcaseexecution','crbversion','','fr','Version de Cerberus',NULL,NULL)");
        SQLS.append(",('testcaseexecution','end','','en','End',' ',NULL)");
        SQLS.append(",('testcaseexecution','executor','','en','Executor user','This is the name of the executor user that executed the <code class=\\'doc-crbvvoca\\'>test case</code>.<br>This data has been created for tracability purpose as the result of Cerberus Test could varry between human and selenium test.',NULL)");
        SQLS.append(",('testcaseexecution','id','','en','Execution ID',' ',NULL)");
        SQLS.append(",('testcaseexecution','IP','','en','IP','This is the ip of the machine of the Selenium Server where the <code class=\\'doc-crbvvoca\\'>test case</code> executed.',NULL)");
        SQLS.append(",('testcaseexecution','Port','','en','Port','This is the port used to contact the Selenium Server where the <code class=\\'doc-crbvvoca\\'>test case</code> executed.',NULL)");
        SQLS.append(",('testcaseexecution','Revision','','en','Revision','Number of the Revision',NULL)");
        SQLS.append(",('testcaseexecution','screensize','','en','Screen Size','This is the real size of the browser screen that performed the execution of the <code class=\\'doc-crbvvoca\\'>test case</code>.',NULL)");
        SQLS.append(",('testcaseexecution','start','','en','Start',' ',NULL)");
        SQLS.append(",('testcaseexecution','status','','en','TC Status','This correspond to the status of the <code class=\\'doc-crbvvoca\\'>test case</code> when it was executed.<br>This is used to identify executions done on stable <code class=\\'doc-crbvvoca\\'>test case</code> compared to the ones done on draft version. ',NULL)");
        ...
        SQLS.append(",('testcaseexecutionqueue','priority','','fr','Priorité',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','css_nb','','en','Css_nb','Number of css downloaded for all the scenario',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','css_nb','','fr','Css_nb',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','css_size_max','','en','Css_size_max','Size of the biggest css dowloaded during the scenario',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','css_size_max','','fr','Css_taille_max',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','css_size_tot','','en','Css_size_tot','Total size of the css for the scenario',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','css_size_tot','','fr','Css_taille_tot',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','css_tps','','en','Css_tps','Cumulated time for download css for all the scenario',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','css_tps','','fr','Css_tps',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','img_nb','','en','Img_nb','Number of pictures downloaded for all the scenario',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','img_nb','','fr','Img_nb',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','img_size_max','','en','Img_size_max','Size of the biggest Picture dowloaded during the scenario',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','img_size_max','','fr','Img_taille_max',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','img_size_tot','','en','Img_size_tot','Total size of the Pictures for the scenario',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','img_size_tot','','fr','Img_taille_tot',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','img_tps','','en','Img_tps','Cumulated time for downloaded pictures for all the scenario',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','img_tps','','fr','Img_tps',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','js_nb','','en','Js_nb','Number of javascript downloaded for all the scenario',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','js_nb','','fr','Js_nb',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','js_size_max','','en','Js_size_max','Size of the biggest javascript dowloaded during the scenario',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','js_size_max','','fr','Js_taille_max',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','js_size_tot','','en','Js_size_tot','Total size of the javascript for the scenario',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','js_size_tot','','fr','Js_taille_tot',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','js_tps','','en','Js_tps','Cumulated time for downloaded javascripts for all the scenario',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','js_tps','','fr','Js_tps','Cumulated time for downloaded javascripts for all the scenario',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','nb_rc2xx','','en','Nb_rc2xx','Number of return code hits between 200 and 300',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','nb_rc2xx','','fr','Nb_cr2xx',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','nb_rc3xx','','en','Nb_rc3xx','Number of return code hits between 300 and 400',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','nb_rc3xx','','fr','Nb_cr3xx',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','nb_rc4xx','','en','Nb_rc4xx','Number of return code hits between 400 and 500',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','nb_rc4xx','','fr','Nb_cr4xx',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','nb_rc5xx','','en','Nb_rc5xx','Number of return code hits higher than 500',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','nb_rc5xx','','fr','Nb_cr5xx',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','tot_nbhits','','en','Tot_nbhits','Total number of hits of a scenario',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','tot_nbhits','','fr','Tot_nbhits',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','tot_size','','en','Tot_size','Total size of all the elements',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','tot_size','','fr','Tot_taille',NULL,NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','tot_tps','','en','Tot_tps','Total time cumulated for the download of all the elements',NULL)");
        SQLS.append(",('testcaseexecutionwwwsum','tot_tps','','fr','Tot_tps',NULL,NULL)");
        SQLS.append(",('testcaselabel','labelId','','en','Label ID','',NULL)");
        SQLS.append(",('testcaselabel','labelId','','fr','ID du label','',NULL)");
        SQLS.append(",('testcasestep','step','','en','Step','A step is a group of actions.',NULL)");
        SQLS.append(",('testcasestepaction','Action','','en','Action','It is the action that will be executed by Cerberus.<br><br>It can take the following values :',NULL)");
        ...
        SQLS.append(",('testcasestepaction','Action','callSoap','en','Call Soap.','TBD',NULL)");
        ...
        SQLS.append(",('testcasestepaction','Action','focusDefaultIframe','en','Focus on the default frame.','TBD',NULL)");
        SQLS.append(",('testcasestepaction','Action','focusToIframe','en','Focus to a specific frame.','TBD',NULL)");
        ...
        SQLS.append(",('testcasestepaction','Action','hideKeyboard','en','Hide keyboard.','Hide the currently visible keyboard.',NULL)");
        ...
        SQLS.append(",('testcasestepaction','Action','manageDialog','en','Manage javascript dialog opened by application, specified ok to accept it or cancel to dismiss','<b>manageDialog</b><br><br>Let possibility to testcase to handle javascript dialog <br>Specify <b>ok</b> value to accept it or <b>cancel</b> to dismiss.',NULL)");
        SQLS.append(",('testcasestepaction','Action','mouseLeftButtonPress','en','Click mouse button and hold it clicked. ','TBD',NULL)");
        SQLS.append(",('testcasestepaction','Action','mouseLeftButtonRelease','en','Release clicked mouse button. ','TBD',NULL)");
        SQLS.append(",('testcasestepaction','Action','mouseOver','en','Mouse cursor over an object.','TBD',NULL)");
        SQLS.append(",('testcasestepaction','Action','mouseOverAndWait','en','Mouse cursor over an object and wait for a certain time.','TBD',NULL)");
        ...
        SQLS.append(",('testcasestepaction','Action','openUrlLogin','en','Open the Login URL.','TBD',NULL)");
        ...
        SQLS.append(",('testcasestepaction','Action','removeDifference','en','Remove Differences.','TBD',NULL)");
        ...
        SQLS.append(",('testcasestepaction','Action','switchToWindow','en','Switching the focus to a window.','When the Test case need to switch to another window (like popup dialog) this action is used. Just specify title of other window in objet to switch to this window.',NULL)");
        SQLS.append(",('testcasestepaction','Action','type','en','Put a data in a field.','<b>type :</b> When the action expected is to type something into a field.<br><br><dd><u><i>How to feed it :</i></u> <br><br><dd><i>Action =</i> type, <i>Value =</i> the <i>id</i> of the field  and <i>Property =</i> the property containing the value to type.<br><br><br>',NULL)");
        SQLS.append(",('testcasestepaction','Action','Unknown','en','Unknown action.','This is the default action defined inside Cerberus.<br>It can be used when the action has not been identified or clarified yet.<br>NB : It is not implemented and will report a FA status on the corresponding execution.',NULL)");
        SQLS.append(",('testcasestepaction','Action','wait','en','Wait for a certain amount of time.','<b>wait :</b> When the action expected is to wait 5 seconds.<br><br><dd><u><i>How to feed it :</i></u> <br><br><dd><i>Action =</i> wait, <i>Value =</i> null  and  <i>Property =</i> null.<br><br><br>',NULL)");
        SQLS.append(",('testcasestepaction','description','','en','Description','This is the functional desciption of the action.',NULL)");
        ...
        SQLS.append(",('testcasestepaction','ForceExeStatus','','fr','Exe CR',NULL,NULL)");
        SQLS.append(",('testcasestepaction','image','','en','Picture','',NULL)");
        SQLS.append(",('testcasestepaction','image','','fr','Image',NULL,NULL)");
        SQLS.append(",('testcasestepaction','Sequence','','en','Sequence','Sequence of execution of the actions inside the step.',NULL)");
        ...
        SQLS.append(",('testcasestepactioncontrol','ConditionOper','','en','Cond','',NULL)");
        SQLS.append(",('testcasestepactioncontrol','ConditionVal1','','en','Val1','',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','','en','Control','It is the control that will be executed by Cerberus.<br><br>It can take the following values :<br>',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','','fr','Vrai si l\\'URL de la page courante est égale à la chaîne de caractères',NULL,NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','getPageSource','en','Save source of the page.','TBD',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','skipControl','en','Skip the control.','TBD',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','takeScreenshot','en','Take a screenshot.','TBD',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','Unknown','en','Default Control in Cerberus','TBD',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyElementClickable','en','True if element is clickable.','<b>verifyElementClickable</b><br><br>Verify if an element is clickable.<br><br><i>Control Property :</i> Element container<br><br>',NULL)");
        ...
        SQLS.append(",('testcasestepactioncontrol','Control','verifyElementNotClickable','en','True if element is not clickable.','<b>verifyElementNotClickable</b><br><br>Verify if an element is not clickable.<br><br><i>Control Property :</i> Element container<br><br>',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyElementNotPresent','en','True if element is not found on the current page.','TBD',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyElementNotVisible','en','True if element is present but not visible on the current page.','<b>verifyElementNotVisible</b><br><br>Verify if the HTML element specified exists, is not visible and has text on it',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyElementPresent','en','True if element is found on the current page.','<b>verifyElementPresent</b><br><br>Verify if an specific element is present on the web page <br><br>',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyElementVisible','en','True if element is visible on the current page.','<b>verifyElementVisible</b><br><br>Verify if the HTML element specified is exists, is visible and has text on it<br><br>',NULL)");
        ...
        SQLS.append(",('testcasestepactioncontrol','Control','verifyIntegerEquals','en','True if the ControlProp is equal to the integer ControlValue.','<b>verifyIntegerEquals</b><br><br>Verify if two integers are equals.<br><br><i>Control Property :</i> The first integer<br><br><i>Control Value :</i> The second integer<br><br>',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyIntegerGreater','en','True if an integer is greater than another.','TBD',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyIntegerMinor','en','True if an integer is lower than another.','TBD',NULL)");
        ...
        SQLS.append(",('testcasestepactioncontrol','Control','verifyStringContains','en','True if Property String contains value String.','<b>verifyStringContains</b><br><br>Verify if the value is contains in the propery<br><b>This test is case sensitive</b>',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyStringDifferent','en','True if 2 strings are different.','TBD',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyStringEqual','en','True if 2 strings are equal.','TBD',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyStringGreater','en','True if a string is greater than another.','TBD',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyStringMinor','en','True if a string is before another.','TBD',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyTextInDialog','en','True if property or value is equal to dialog text retrieved.','<b>verifyTextInDialog</b><br><br>Verify if the text in dialog is equal to property or dialog.',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyTextInElement','en','True if a text is inside a field.','TBD',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyTextInPage','en','True if a text is inside the source of the current page.','TBD',NULL)");
        ...
        SQLS.append(",('testcasestepactioncontrol','Control','verifyTextNotInPage','en','True if a text is not inside the source of the current page.','TBD',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Control','verifyTitle','en','True if the title of the current page equal to a string.','<b>verifytitle</b><br><br>Verify if the title of the webpage is the same than the value specified<br><br>',NULL)");
        ...
        SQLS.append(",('testcasestepactioncontrol','Control','verifyXmlTreeStructure','en','Check if XML tree Structure is correct.','TBD',NULL)");
        SQLS.append(",('testcasestepactioncontrol','ControlSequence','','en','CtrlNum','This is the number of the control.<br>If you have more than one control attached to an action, use this value to order their execution.',NULL)");
        SQLS.append(",('testcasestepactioncontrol','ControlSequence','','fr','CtrlNum',NULL,NULL)");
        SQLS.append(",('testcasestepactioncontrol','Description','','en','Description','This is the functional desciption of the control.',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Fatal','','en','Fatal','This define if the control is fatal.<br><br>If the control is fatal and KO, the execution will stop and execution status will report KO.<br>If the control is not fatal and KO, the execution will continue but execution status will still report a KO.',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Sequence','','en','Sequence','It is the number of the sequence in which the control will be performed.<br><br>NB : Controls are performed after each action.',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Sequence','','fr','Séquence',NULL,NULL)");
        SQLS.append(",('testcasestepactioncontrol','Step','','en','Step','',NULL)");
        SQLS.append(",('testcasestepactioncontrol','Step','','fr','Etape',NULL,NULL)");
        ...
        SQLS.append(",('testcasestepactioncontrolexecution','ReturnCode','','en','Control Return Code','Return Code of the Control.',NULL)");
        SQLS.append(",('testcasestepactioncontrolexecution','ReturnMessage','','en','Return Message','This is the return message on that specific control.',NULL)");
        SQLS.append(",('testcasestepactionexecution','ForceExeStatus','','en','Force Execution RC','This is the value of the Force Execution Status data used by the engine during the execution of the testcase.',NULL)");
        SQLS.append(",('testcasestepactionexecution','ForceExeStatus','','fr','Force Execution CR',NULL,NULL)");
        SQLS.append(",('testcasestepactionexecution','ReturnCode','','en','Action Return Code','This is the return code of the action.',NULL)");
        SQLS.append(",('testcasestepactionexecution','ReturnCode','','fr','Code retour de l\\'action','C\\'est le code retour de l\\'action',NULL)");
        SQLS.append(",('testcasestepactionexecution','ReturnMessage','','fr','Message retourné','C\\'est le message retourné par le contrôle',NULL)");
        SQLS.append(",('testcasestepactionexecution','screenshotfilename','','en','Screenshot Filename','This is the filename of the screenshot.<br>It is null if no screenshots were taken.',NULL)");
        ...
        SQLS.append(",('testdatalib','actions','','fr','Actions',NULL,'_librairie_de_données')");
        ...
        SQLS.append(",('testdatalib','actions_nopermissions','','fr','Actions',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalib','country','','en','Country','<p>Country where the entry is available. If not specified, then the data entry apply to ALL countries. </p>','_data_library')");
        SQLS.append(",('testdatalib','country','','fr','Pays',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalib','created','','en','Creation Date','','_data_library')");
        SQLS.append(",('testdatalib','created','','fr','Date de création',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalib','creator','','en','Creator','User who created the data.','_data_library')");
        SQLS.append(",('testdatalib','creator','','fr','Créateur',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalib','csvUrl','','en','CSV URL','<p>CSV URL specifies the URL where the CSV can be reached.</p>','_data_library')");
        SQLS.append(",('testdatalib','csvUrl','','fr','URL du CSV','<p>L’URL du CSV représente l’URL du fichier CSV à décrypter.</p>','_librairie_de_données')");
        ...
        SQLS.append(",('testdatalib','database','','fr','Base de Données',NULL,'_librairie_de_données')");
        ...
        SQLS.append(",('testdatalib','databaseCsv','','fr','Base de données',NULL,'_librairie_de_données')");
        ...
        SQLS.append(",('testdatalib','databaseUrl','','fr','Base de données','','_librairie_de_données')");
        SQLS.append(",('testdatalib','description','','en','Description','<p>Textual description of the entry.</p>','_data_library')");
        SQLS.append(",('testdatalib','description','','fr','Description',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalib','envelope','','en','Envelope','<p>Envelope that should be sent in the SOAP request.</p>','_data_library')");
        SQLS.append(",('testdatalib','envelope','','fr','Enveloppe','<p>Enveloppe qui doit être envoyée dans la requête SOAP</p>','_librairie_de_données')");
        SQLS.append(",('testdatalib','environment','','en','Environment','<p>Environment where the entry is available. If not specified, then the data entry apply to ALL environments.</p>','_data_library')");
        SQLS.append(",('testdatalib','environment','','fr','Environnement',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalib','group','','en','Group','<p>Name that groups entries that are at some extent correlated. It is an <b>optional</b> attribute.</p>','_data_library')");
        SQLS.append(",('testdatalib','group','','fr','Groupe',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalib','lastmodified','','en','Modification Date','','_data_library')");
        SQLS.append(",('testdatalib','lastmodified','','fr','Dernière modification',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalib','lastmodifier','','en','Last Modifier','User who last modified the data.','_data_library')");
        SQLS.append(",('testdatalib','lastmodifier','','fr','Dernier modificateur','Utilisateur qui a modifié en dernier la donnée','_librairie_de_données')");
        SQLS.append(",('testdatalib','method','','en','Operation','<p>Operation that is invoked by the SOAP request/call.</p>','_data_library')");
        SQLS.append(",('testdatalib','method','','fr','Operation','<p>Operation à appeler pour la Requête SOAP.</p>','_librairie_de_données')");
        SQLS.append(",('testdatalib','name','','en','Name','<p>Name of the entry. It is a <b>mandatory</b> attribute.</p><p><b><u>Note</u></b>: The combination of <u>Name</u>, <u>System</u>, <u>Environment</u> and <u>Country</u> can be duplicated when the type is STATIC in order to allow a list of data to be available.</p>','_data_library')");
        SQLS.append(",('testdatalib','name','','fr','Nom','<p>Nom de la donnée</p>','_librairie_de_données')");
        SQLS.append(",('testdatalib','script','','en','Script','<p>SQL commands that should be executed to retrieve test data.</p><p>Examples:</p><table><tr><td>select * from table;</td></tr><tr><td>select * from table where column = %COLUMN%;</td></tr></table>','_data_library')");
        SQLS.append(",('testdatalib','script','','fr','Scenario',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalib','separator','','en','Separator','<p>Separator used parsing a CSV.</p>','_data_library')");
        SQLS.append(",('testdatalib','separator','','fr','Séparateur','<p>Séparateur à utiliser pour le décryptage du CSV.</p>','_librairie_de_données')");
        SQLS.append(",('testdatalib','service','','en','Service','','_data_library')");
        SQLS.append(",('testdatalib','service','','fr','Service',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalib','servicepath','','en','Service Path','<p>Location of the service.</p><p>Examples:</p><table><tr><td>http://mydomain/mywebservicelocation</td></tr><tr><td>mywebservicelocation</td></tr><tr><td>http://%MY_DYNAMIC_IP%/mywebservicelocation</td></tr><tr><td>%LOCATION%</td></tr></table>','_data_library')");
        SQLS.append(",('testdatalib','servicepath','','fr','Chemin du Service',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalib','system','','en','System','<p>System where the entry is available. If not specified, then the data entry apply to ALL systems.</p>','_data_library')");
        SQLS.append(",('testdatalib','system','','fr','Système',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalib','testdatalibid','','en','ID','<p>Unique identifier of the test data library entry</p>','_data_library')");
        SQLS.append(",('testdatalib','testdatalibid','','fr','Identifiant','<p>Identifiant unique de librairie de donnée</p>','_librairie_de_données')");
        ...
        SQLS.append(",('testdatalib','type','','fr','Type',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalibdata','column','','en','Column','<p>Column name representing the value that should be obtained after executing a SQL instruction (select).</p>','_data_library')");
        SQLS.append(",('testdatalibdata','column','','fr','Colonne','<p>Nom de la colonne représentant la vakeur qui devrait être obtenu après l\\'execution du SQL</p>','_librairie_de_données')");
        SQLS.append(",('testdatalibdata','columnPosition','','en','Column Position','<p>Column position [1,2,3…] representing the value that should be obtained after parsing a CSV file.</p>','_data_library')");
        SQLS.append(",('testdatalibdata','columnPosition','','fr','Position','<p>Position [1,2,3…] de la valeur à obtenir lors du décryptage du CSV.</p>','_librairie_de_données')");
        SQLS.append(",('testdatalibdata','description','','en','Description','<p>Textual description for the sub-data entry.</p>','_data_library')");
        SQLS.append(",('testdatalibdata','description','','fr','Description',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalibdata','parsingAnswer','','en','Parsing Answer','<p>XPath or JsonPath expression that allows the user to parse data from the SERVICE response.</p>','_data_library')");
        SQLS.append(",('testdatalibdata','parsingAnswer','','fr','Analyse de la réponse',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalibdata','subData','','en','Sub-data ','<p>Unique name for a sub-data entry. For a test data library entry, this value should be unique.</p>','_data_library')");
        SQLS.append(",('testdatalibdata','subData','','fr','Sous-donnée',NULL,'_librairie_de_données')");
        SQLS.append(",('testdatalibdata','value','','en','Value','<p>STATIC value.</p>','_data_library')");
        SQLS.append(",('testdatalibdata','value','','fr','Valeur',NULL,'_librairie_de_données')");
        SQLS.append(",('transversal','DateCreated','','en','Creation Date','Date of the creation of the object.','_data_library')");
        SQLS.append(",('transversal','DateCreated','','fr','Date de Création','Date de création de l\\'objet.','_librairie_de_données')");
        SQLS.append(",('transversal','DateModif','','en','Modification Date','Last modification Date of the object.','_data_library')");
        SQLS.append(",('transversal','DateModif','','fr','Date de Modification','Date de dernière modification de l\\'objet.','_librairie_de_données')");
        SQLS.append(",('transversal','UsrCreated','','en','Created by','User who created the object.','_data_library')");
        SQLS.append(",('transversal','UsrCreated','','fr','Créé par','Utilisateur ayant créé l\\'objet.','_librairie_de_données')");
        SQLS.append(",('transversal','UsrModif','','en','Modified by','Last modification date of the object.','_data_library')");
        SQLS.append(",('transversal','UsrModif','','fr','Modifié par','Date de dernière modification de l\\'objet.','_librairie_de_données')");
        SQLS.append(",('user','DefaultSystem','','en','Default System','This is the default <code class=\\'doc-crbvvoca\\'>system</code> the user works on the most. It is used to default the perimeter of <code class=\\'doc-crbvvoca\\'>test case</code> or <code class=\\'doc-crbvvoca\\'>applications</code> displayed on some Cerberus pages.','_user_management')");
        SQLS.append(",('user','DefaultSystem','','fr','Système par defaut','Système par defaut','_management_des_utilisateurs')");
        SQLS.append(",('user','Team','','en','Team','This is the team of the user.','_user_management')");
        ...
        SQLS.append("title varchar(61) not null,");
        SQLS.append("description varchar(255) not null,");
        SQLS.append("role varchar(31) not null,");
        SQLS.append("ord int not null,");
        SQLS.append("level int not null"); // 1 easy, 2 intermediate, 3 hard
        SQLS.append(")");
        SQLInstruction.add(SQLS.toString());
        ...
        SQLS.append("type varchar(31) not null,");
        SQLS.append("attr1 varchar(125),");
        ...
        SQLS = new StringBuilder();
        SQLS.append("INSERT INTO `interactive_tuto` (`id`, `title`, `description`, `role`, `ord`, `level`) VALUES \n");
        SQLS.append("  (1, 'First step for an Admin', 'Learn the first step to initialize cerberus and create your first test system', 'Administrator', 0, 1),\n");
        SQLS.append("  (2, 'First step for a Test Implementer', 'Learn how implement your first test','Test', 100, 1),\n");
        SQLS.append("  (3, 'Web implementation', 'Web implementation for beginner. Describe more about it','Test', 100, 1),\n");
        SQLS.append("  (4, 'Web implementation', 'Web implementation for intermediate user. Describe more about it','Test', 102, 2),\n");
        SQLS.append("  (5, 'Web implementation', 'Web implementation for expert. Describe more about it','Test', 104,3)");
        ...
        // general page
        SQLS = new StringBuilder();
        SQLS.append("INSERT INTO `interactive_tuto_step` (`id_interactive_tuto`, `step_order`, `selector`,  `type`, `attr1`, `description`) VALUES \n");
        SQLS.append("  (1, 30,  '#sidebar',                 'changePageAfterClick', '#menuInvariants',   'Vous êtes administrateur ! La 1ere étape de configuration est de créer un système.\n");
        ...
        // Page invariant, null,
        SQLS.append("  (1, 35, '#createInvariantButton',    'default',              null,                'Clique sur Creer un invariant'),\n");
        SQLS.append("  (1, 40, '#idname',                   'default',              null,                'Selectionne SYSTEM dans la liste'),\n");
        SQLS.append("  (1, 45, '#value',                    'default',              null,                'Donne un nom à ton systeme'),\n");
        SQLS.append("  (1, 50, '#addInvariantButton',       'default',              null,                'Et valide ton nouveau systeme'),\n");
        SQLS.append("  (1, 55, '#sidebar',                  'changePageAfterClick', '#menuEnvironments', 'Voilà, ton sytème est créé ! Prochaine étape : il faut créez un environnement. L''<b>environement</b>\n");
        ...
        SQLS.append("  (1, 60, '#createEnvButton',          'default',              null,                'Clique sur <b>Creer un environement</b>'),\n");
        SQLS.append("  (1, 65, '#system',                   'default',              null,                'Selectionne le système que tu viens de creer'),\n");
        SQLS.append("  (1, 70, '#country',                  'default',              null,                'Selectionne le pays - TODO recuperer l''aide du pays'),\n");
        SQLS.append("  (1, 75, '#environment',              'default',              null,                'Selectionne l''environnement sur lequel tu veux faire tourner le système'),\n");
        SQLS.append("  (1, 80, '#description',              'default',              null,                'Ajoute une description de l''environnement'),\n");
        SQLS.append("  (1, 85, '#addEnvButton',             'default',              null,                'Et valide l''environement'),\n");
        SQLS.append("  (1, 90, '#sidebar',                  'changePageAfterClick', '#menuDeployType',   'Prochaine étape : vérifier qu''un type de déploiement existe. Rendez vous dans <b>Application/Type de deploiement</b>'),\n");

        // type de deploiement, null,
        SQLS.append("  (1, 95, '#createDeployTypeButton',   'default',              null,                'Creer un nouveau type de deploiement'),\n");
        SQLS.append("  (1, 100,'#deployType',               'default',              null,                'Renseigne le nom du type de deploiement'),\n");
        SQLS.append("  (1, 105,'#Description',              'default',              null,                'Decrit le type de deploiement'),\n");
        SQLS.append("  (1, 110,'#addEntryButton',           'default',              null,                'Et sauvegarde le type de deploiement'),\n");
        SQLS.append("  (1, 115,'#sidebar',                  'changePageAfterClick', 'a#menuApplications',                'Dernière étape : créer une application. Rendez vous dans <b>Application/Application</b>'),\n");
        // page application, null,
        SQLS.append("  (1, 120,'#createApplicationButton',  'default',              null,                'Clique sur <b>Creer une application</b>'),\n");
        SQLS.append("  (1, 125,'#application',              'default',              null,                'Entre le nom de l''application que tu veux tester'),\n");
        SQLS.append("  (1, 130,'#description',              'default',              null,                'Entre une description'),\n");
        SQLS.append("  (1, 135,'#type',                     'default',              null,                'Entre le type d''application (web, mobile, client riche etc...)'),\n");
        SQLS.append("  (1, 140,'#system',                   'default',              null,                'Selectionne le système'),\n");
        SQLS.append("  (1, 145,'#deploytype',               'default',              null,                'Selectionne le type de deploiement prevu pour l''application'),\n");
        SQLS.append("  (1, 150,'#addApplicationButton',     'default',              null,                'Et valide l''application !'),\n");
        SQLS.append("  (1, 155, null,                       'general',              null,                'Bravo! Tu es prêt à creer tes premiers cas de test sur l''application que tu viens de créer. >>> Passer au tuto suivant')\n");
        ...
        // A test who cret
        SQLS.append("INSERT INTO `interactive_tuto_step` (`id_interactive_tuto`, `step_order`, `selector`,  `type`, `attr1`, `description`) VALUES \n");
        SQLS.append("  (1, 0,   null,                       'genral',               null,                   'Nous allons apprendre à faire ouvrir une url, naviguer sur un site, et tester si des du texte ou des éléments sont présent sur la page.'),");
        SQLS.append("  (1, 5,'#sidebar',                    'changePageAfterClick', '#menuEditTest',        'Première étape : créer un nouveau test. Rendez-vous dans <b>Test/Test</b>'),\n");

        // Page test
        SQLS.append("  (1, 10,'#createTestButton',          'default',              null,                   'Le <b>Test</b> est un ensemble de cas de tests regroupés découpés par fonction d’application. Ici, nous allons commencer créer un premier <b>Test</b> pour test la page du site vitrine Cerberus'),\n");
        SQLS.append("  (1, 15,'#test',                      'default',              null,                   'Nommons donc notre test <b>Site Vitrine Cerberus Testing IHM</b>'),\n");
        SQLS.append("  (1, 25,'#addEntryButton',            'default',              null,                   'Et sauvegardons!'),\n");
        SQLS.append("  (1, 5,'.dataTables_scroll',          'changePageAfterClick', '#testCaseLink',        'On peut maintenant creer des <b>cas de test</b>! Cliquer directement sur img pour acceder au <b>cas de test</b> de votre nouveau <b>test</b>'),\n");
